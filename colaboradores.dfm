object FColaboradores: TFColaboradores
  Left = 330
  Top = 205
  ...
  object PCadastro: TPanel
    ...
    object PBotoes: TSQLPanelGrid
      ...
      object bexporta: TSQLBtn
        Left = 1
        Top = 234
        Width = 95
        Height = 25
        Hint = 'Exporta os colaboradores para o ponto'
        Caption = '&Exp.Ponto'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdCola_codigo: TSQLEd
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TColaboradores
          TableName = 'colaboradores'
          TableField = 'Cola_codigo'
          PanelMessages = PMens
        end
        object EdCola_descricao: TSQLEd
          Left = 49
          Top = 23
          Width = 182
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Nome do colaborador'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TColaboradores
          TableName = 'colaboradores'
          TableField = 'Cola_descricao'
          PanelMessages = PMens
        end
        object EdCola_usua_codigo: TSQLEd
          Left = 372
          Top = -1
          Width = 50
          Height = 21
          ...
          Table = Arq.TColaboradores
          TableName = 'colaboradores'
          TableField = 'Cola_usua_codigo'
          PanelMessages = PMens
        end
        object EdCola_seto_codigo: TSQLEd
          Left = 379
          Top = 23
          Width = 49
          Height = 21
          ...
          CloseFormEsc = False
          ShowForm = 'FSetores'
          OnExitEdit = EdCola_seto_codigoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          Table = Arq.TColaboradores
          TableName = 'colaboradores'
          TableField = 'Cola_seto_codigo'
          PanelMessages = PMens
        end
        object EdCola_cpf: TSQLEd
          Left = 239
          Top = 26
          Width = 127
          Height = 21
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'cola_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cola_descricao'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cola_seto_codigo'
            Visible = True
          end
          item
            Expanded = False
