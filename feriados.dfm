    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdFeri_data: TSQLEd
          ...
          Table = Arq.TFeriados
          TableName = 'FERIADOS'
          TableField = 'Feri_data'
          PanelMessages = PMens
        end
        object EdFeri_descricao: TSQLEd
          Left = 74
          Top = 15
          Width = 250
          Height = 21
          ...
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Descri'#231#227'o Do Feriado'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o do feriado'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TFeriados
          TableName = 'FERIADOS'
          TableField = 'Feri_descricao'
          PanelMessages = PMens
        end
        object EdFeri_abrangencia: TSQLEd
          Left = 334
          Top = 15
          Width = 20
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdFeri_abrangenciaExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Abrang'#234'ncia'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Abrang'#234'ncia do feriado'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'FERI_DESCRICAO'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'FERI_ABRANGENCIA'
            Visible = True
          end>
      end
    end
