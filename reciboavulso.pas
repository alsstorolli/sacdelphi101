...
//     FTExtRel.Init();
// 26.11.12 - para ter opção de imprimir em laser
...
//     for i:=1 to Copias do Texto.Print('Imprimindo Relatório');
...
begin
      if Input('Destinatário de e-mail','E-Mail',Endereco,0,False) and (Endereco<>'') then begin
        ...
        Corpo.Header.Subject:='Quitação de valores';
        Corpo.EncodeMessage;
