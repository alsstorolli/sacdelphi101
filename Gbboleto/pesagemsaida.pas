...
var
  ...
  Sqltipomov,Unidade,Transacao,OperacaoPesada,ChecaCodBarra,xop,Tipomov,IncluiPed:string;
...
uses Geral,SqlFun, Estoque, impressao, RelGerenciais, nfsaida,
  expnfetxt, cadcli, munic, Unidades, pcnNFe, grupos;
...
///////////////////////////////////////////
procedure TFPesagemSaida.Execute(op:string='');
//////////////////////////////////
begin
   xop:=op;
   tipomov:='SA';
...
// 09.05.17
   end else if QPedido.fieldbyname('movd_pesobalanca').AsCurrency > 0 then begin
