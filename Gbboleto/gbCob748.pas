        ...
        end;
{
        ...
        case Titulos[NumeroRegistro].Postagem of
         ...
         Registro := Registro + 'C'; // TIPO DE COBRANÇA - SEM REGISTRO
         Registro := Registro + Formatar('', 14); // ESPAÇOS EM BRANCO
         ...
         Registro := Registro + Formatar('', 28); // ESPAÇOS EM BRANCO
         // Adtaptação
         NossoNumero := Formatar(Titulos[NumeroRegistro].NossoNumero, 9, True, '0'); // IDENT. DO TITULO NO BANCO COM DIG VERIFICADOR
{
         ...
         Registro := Registro + Formatar('', 1); // ESPAÇOS EM BRANCO
         Registro := Registro + 'B'; // TIPO DE IMPRESSÃO - COMPLETA
         Registro := Registro + Formatar('', 13); // ESPAÇOS EM BRANCO
         Registro := Registro + Formatar(aPostagem, 1, True, '0'); // POSTAGEM - SIM
         Registro := Registro + Formatar('', 2); // ESPAÇOS EM BRANCO
         Registro := Registro + '00'; // NUMERO DA PARCELA NO CARNÊ
         Registro := Registro + '00'; // NÚMERO DE PARCELAS NO CARNÊ
         Registro := Registro + Formatar('', 4); // ESPAÇOS EM BRANCO
//         Registro := Registro + FormatCurr('0000000000', Titulos[NumeroRegistro].DescPorDiaAntecipa * 100); // DESCONTO POR DIA DE ANTECIPAÇÃO
//         Registro := Registro + formatCurr('0000', Titulos[NumeroRegistro].MultaPagAtraso * 100); // MULTA POR PAGAMENTO EM ATRASO
         Registro := Registro + Formatar('', 12); // ESPAÇOS EM BRANCO
         Registro := Registro + Formatar(ATitulosTipoOcorrencia, 2, True, '0'); // INSTRUÇÃO
         Registro := Registro + Formatar(Titulos[NumeroRegistro].SeuNumero, 10, False, '0'); // SEU NÚMERO DIFERENTE DE BRANCO
         ...
         Registro := Registro + Formatar('', 9); // ESPAÇOS EM BRANCO
         Registro := Registro + Formatar(aTitulosEspecieDocumento, 1, False, '0'); // ESPÉCIE DO TITULO
         Registro := Registro + Formatar('', 1); // ESPAÇOS EM BRANCO
         ...
         Registro := Registro + Formatar('', 26); // ESPAÇOS EM BRANCO
...
//         Registro := Registro + Formatar(Titulos[NumeroRegistro].Sacado.CodSacAgCed, 5, True, '0'); // CÓDIGO DO SACADO NA AGÊNCIA CEDENTE
//         Registro := Registro + Formatar(Titulos[NumeroRegistro].Sacado.CodPraca, 6, True, '0'); // CÓDIGO DA PRAÇA DO SACADO
         Registro := Registro + Formatar('', 1); // ESPAÇOS EM BRANCO
...
//         Registro := Registro + Formatar(Titulos[NumeroRegistro].Sacado.CodSacCli, 5, True, '0'); //CÓIDO DO SACADO JUNTO AO CLIENTE
         Registro := Registro + Formatar('', 28); // ESPAÇOS EM BRANCO
         {
      ...
      Remessa.Add('9'+'1'+'748'+ // IDENT. DO REGISTRO
                  Formatar(CodigoCedente, 5, True, '0') + // CÓDIGO DO CEDENTE.
