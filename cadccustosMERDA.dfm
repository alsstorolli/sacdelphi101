    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdCCst_codigo: TSQLEd
          ...
          Text = ''
          Visible = True
          OnKeyPress = EdCCst_codigoKeyPress
          Empty = False
          CloseForm = False
          CloseFormEsc = False
          ColorFocus = clBlack
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo do centro de custo'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
        ...
        object Edccst_descricao: TSQLEd
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = Edccst_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o do centro de custo'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
        ...
        object EdCcst_reduzido: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo da reduzido'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
