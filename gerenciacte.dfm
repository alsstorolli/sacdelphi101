object FGerenciaCte: TFGerenciaCte
  Left = 288
  Top = 121
  BorderStyle = bsDialog
  Caption = 'Gerenciamento de CTe'
  ClientHeight = 525
  ClientWidth = 901
  Color = clBtnFace
  ...
  object PCadastro: TPanel
    ...
    object PBotoes: TSQLPanelGrid
      ...
      object bimpdacte: TSQLBtn
        Left = 3
        Top = 28
        Width = 95
        Height = 25
        Hint = 'Imprime o Dacte'
        Caption = '&Imp.Dacte'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object bcancelacte: TSQLBtn
        Left = 3
        Top = 54
        Width = 95
        Height = 25
        Hint = 'Cancela CTe'
        Caption = 'C&ancelar CTe'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
      ...
      object bdesacordo: TSQLBtn
        Left = 4
        Top = 206
        Width = 95
        Height = 28
        Hint = 'Envia evento de desacardo de CTE reebido'
        Caption = '&Desacordo'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
    ...
    object Panel1: TPanel
      ...
      object EdNumeroi: TSQLEd
        ...
        CloseForm = False
        CloseFormEsc = False
        OnExitEdit = EdNumeroiExitEdit
        OnValidate = EdNumeroiValidate
        ColorFocus = clBlack
        ColorTextFocus = clWhite
        ColorNotEnabled = clGray
        ColorTextNotEnabled = clWhite
        Title = 'Numera'#231#227'o CTe'
        TitlePos = tppTop
        TitleFont.Charset = DEFAULT_CHARSET
        TitleFont.Color = clWindowText
        TitleFont.Height = -11
