object FSittributaria: TFSittributaria
  Left = 368
  Top = 154
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdSITT_CODIGO: TSQLEd
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TSittributaria
          TableName = 'SITTRIB'
          TableField = 'SITT_CODIGO'
          PanelMessages = PMens
        end
        object EdSITT_DESCRICAO: TSQLEd
          Left = 51
          Top = 16
          Width = 312
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o da situa'#231#227'o tribut'#225'ria'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TSittributaria
          TableName = 'SITTRIB'
          TableField = 'SITT_DESCRICAO'
          PanelMessages = PMens
        end
        object EdSITT_CST: TSQLEd
          Left = 427
          Top = 17
          Width = 43
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Codigo utilizado na situa'#231#227'o tribut'#225'ria'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
        ...
        object EdSITT_CF: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Codigo fiscal para tipo de tributa'#231#227'o'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
        ...
        object EdSITT_USUA_CODIGO: TSQLEd
          Left = 312
          Top = -8
          Width = 68
          Height = 21
          ...
          Table = Arq.TSittributaria
          TableName = 'SITTRIB'
          TableField = 'SITT_USUA_CODIGO'
          PanelMessages = PMens
        end
        object EdSitt_Natf_codigo: TSQLEd
          Left = 177
          Top = 52
          Width = 39
          Height = 21
        ...
        object EdSITT_ES: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Se refere a movimento de entrada e ou saida'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
        ...
        object Edsitt_natf_codigofe: TSQLEd
          Left = 280
          Top = 52
          Width = 39
          Height = 21
          ...
          Table = Arq.TSittributaria
          TableName = 'SITTRIB'
          TableField = 'sitt_natf_codigofe'
          PanelMessages = PMens
        end
        object SetEdnatf_descricao: TSQLEd
          Left = 322
          Top = 52
          Width = 60
          Height = 21
        ...
        object Edsitt_cstme: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Codigo utilizado na situa'#231#227'o tribut'#225'ria para optantes do simples'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          ...
          Table = Arq.TSittributaria
          TableName = 'SITTRIB'
          TableField = 'sitt_cstme'
          PanelMessages = PMens
        end
        object EdSITT_CSTPIS: TSQLEd
          Left = 63
          Top = 52
          Width = 43
          Height = 21
          ...
          Table = Arq.TSittributaria
          TableName = 'SITTRIB'
          TableField = 'SITT_CSTPIS'
          PanelMessages = PMens
        end
        object EdSITT_CSTCOFINS: TSQLEd
          Left = 111
          Top = 52
          Width = 58
          Height = 21
          ...
          Table = Arq.TSittributaria
          TableName = 'SITTRIB'
          TableField = 'SITT_CSTCOFINS'
          PanelMessages = PMens
        end
        object EdSITT_Cbenef: TSQLEd
          Left = 369
          Top = 16
          Width = 50
          Height = 21
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'SITT_NATF_CODIGO'
            Title.Caption = 'CFOP'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'sitt_natf_codigofe'
            Visible = True
          end
          item
            Expanded = False
          ...
          item
            Expanded = False
            FieldName = 'sitt_cstme'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'sitt_cstpis'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'sitt_cstcofins'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'sitt_cbenef'
            Title.Caption = 'Ben.Fiscal'
            Visible = True
          end>
      end
    end
