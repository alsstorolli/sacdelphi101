    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdSeto_descricao: TSQLEd
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdSeto_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
        ...
        object EdSeto_usua_codigo: TSQLEd
          Left = 309
          Top = 17
          Width = 50
          Height = 21
          ...
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Usu'#225'rio Respons'#225'vel'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          ...
          FindSetEdt = SetEdusua_nome
          Group = 0
          Table = Arq.TSetores
          TableName = 'setores'
          TableField = 'Seto_usua_codigo'
          PanelMessages = PMens
        end
        object SetEdusua_nome: TSQLEd
          Left = 366
          Top = 17
          Width = 99
          Height = 21
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'seto_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'seto_descricao'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'seto_usua_codigo'
            Visible = True
          end>
      end
    end
