...
// 08.07.19 - Vinicius Rotta
    function GetPercIcmsSubs(codigo:string):currency;
...
// 08.07.19
function TFCodigosFiscais.GetPercIcmsSubs(codigo: string): currency;
////////////////////////////////////////////////////////////////////
var Q:TSqlquery;
begin

  Q:=sqltoquery('select Cfis_AliqST from codigosfis where cfis_codigo='+stringtosql(codigo));
  if not Q.eof then
    Result:=Q.fieldbyname('Cfis_AliqST').AsCurrency
  else
    Result:=0;
  FGeral.Fechaquery(Q);
