    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdFaix_codigo: TSQLEd
          ...
          Text = ''
          Visible = True
          OnKeyPress = EdFaix_codigoKeyPress
          Empty = True
          CloseForm = False
          CloseFormEsc = False
          OnValidate = EdFaix_codigoValidate
          ColorFocus = clBlack
          ...
          Table = Arq.TFaixas
          TableName = 'faixas'
          TableField = 'Faix_codigo'
          PanelMessages = PMens
        end
        object EdFaix_seq: TSQLEd
          Left = 96
          Top = 30
          Width = 50
          Height = 21
        ...
        object EdFaix_inicio: TSQLEd
          ...
          Table = Arq.TFaixas
          TableName = 'faixas'
          TableField = 'Faix_inicio'
          PanelMessages = PMens
        end
        object EdFaix_fim: TSQLEd
          Left = 225
          Top = 30
          Width = 66
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnValidate = EdFaix_fimValidate
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'T'#233'rmino Faixa'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
        ...
        object EdFaix_usua_codigo: TSQLEd
          Left = 301
          Top = 56
          Width = 50
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Usu'#225'rio que informou'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          ...
          Table = Arq.TFaixas
          TableName = 'faixas'
          TableField = 'Faix_usua_codigo'
          PanelMessages = PMens
        end
        object EdFaix_valor: TSQLEd
          Left = 303
          Top = 30
          Width = 60
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdFaix_valorExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Valor da faixa de valores'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 5
          ValueFormat = '###,##0.00000'
          ...
          Table = Arq.TFaixas
          TableName = 'faixas'
          TableField = 'Faix_valor'
          PanelMessages = PMens
        end
        object EdFaix_status: TSQLEd
          Left = 365
          Top = 54
          Width = 50
          Height = 21
