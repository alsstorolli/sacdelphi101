  ...
  object Panel1: TPanel
    ...
    object PEdits: TSQLPanelGrid
      ...
      object EdHist_codigo: TSQLEd
        ...
        Text = ''
        Visible = True
        OnKeyPress = EdHist_codigoKeyPress
        Empty = False
        CloseForm = False
        CloseFormEsc = False
        ColorFocus = clBlack
        ...
        MinLength = 0
        Group = 0
        Table = Arq.THistoricos
        TableName = 'HISTORICOS'
        TableField = 'Hist_codigo'
        PanelMessages = PMens
      end
      object EdHist_descricao: TSQLEd
        Left = 43
        Top = 14
        Width = 201
        Height = 21
        ...
        CloseForm = False
        CloseFormEsc = False
        OnExitEdit = EdHist_complementoExitEdit
        ColorFocus = clBlack
        ColorTextFocus = clWhite
        ColorNotEnabled = clGray
        ColorTextNotEnabled = clWhite
        ...
        Table = Arq.THistoricos
        TableName = 'HISTORICOS'
        TableField = 'Hist_descricao'
        PanelMessages = PMens
      end
      object EdHist_complemento: TSQLEd
        Left = 259
        Top = 14
        Width = 169
        Height = 21
        ...
        CharUpperLower = True
        Items.Strings = (
          '#001 - N'#250'mero do documento'
          '#002 - C'#243'digo da unidade'
          '#003 - C'#243'digo da esp'#233'cie'
          '#004 - C'#243'digo da entidade (fornecedor/cliente...)'
          '#005 - Nome da entidade(fornecedor/cliente...)'
          '#020 - Data do movimento'
          '#021 - M'#234's da data do movimento'
          '#022 - M'#234's/Ano da data do movimento'
          '#030 - Data cont'#225'bil'
          '#031 - M'#234's da data cont'#225'bil'
          '#032 - M'#234's/Ano da data cont'#225'bil'
          '')
        ItemsMultiples = True
        ItemsValid = False
        ItemsWidth = 0
