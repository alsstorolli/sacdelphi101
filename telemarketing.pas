...
//   Edmovt_obspro.text      :=
   EdBanco.text         := Qa.fieldbyname('movt_banco').asstring;
   EdTipoconta.text     := Qa.fieldbyname('movt_tipoconta').asstring;
   EdAgencia.text       := Qa.fieldbyname('movt_agencia').asstring;
   Edconta.text         := Qa.fieldbyname('movt_conta').asstring;
   EdBeneficio.text     := Qa.fieldbyname('movt_beneficio').asstring;
   EdPrazo.text         := Qa.fieldbyname('movt_parcelas').asstring;
   EdValorliberado.setvalue( Qa.fieldbyname('movt_Valorliberado').ascurrency );
   EdValorsolicitado.setvalue( Qa.fieldbyname('movt_Valorsolicitado').ascurrency );
   EdParcela.setvalue( Qa.fieldbyname('movt_Parcela').ascurrency );
...
begin
   ...
   if linha>=0 then begin
      ...
      lin:=linha;
      Grid.Cells[Grid.GetColumn('movt_situacao'),lin]:= Grid.cells[Grid.getcolumn('movt_situacao'),lin];
...
// 02.09.2021 - deixa como A -> Atendido
       Sistema.SetField('movt_situacao','A');
       Sistema.SetField('movt_banco',EdBanco.text);
       Sistema.SetField('movt_tipoconta',EdTipoconta.text);
       Sistema.SetField('movt_agencia',EdAgencia.text);
       Sistema.SetField('movt_conta',Edconta.text);
       Sistema.SetField('movt_beneficio',EdBeneficio.text);
       Sistema.SetField('movt_parcelas',EdPrazo.text);
       Sistema.SetField('movt_Valorliberado',EdValorliberado.ascurrency);
       Sistema.SetField('movt_Valorsolicitado',EdValorsolicitado.ascurrency);
       Sistema.SetField('movt_Parcela',EdParcela.ascurrency);
