object FRelMalote: TFRelMalote
  Left = 359
  Top = 220
  BorderStyle = bsDialog
  Caption = 'Relat'#243'rios para Malote'
  ClientHeight = 341
  ClientWidth = 520
  Color = clBtnFace
  ...
  object PRel: TSQLPanelGrid
    ...
    object EdCodtipo: TSQLEd
      ...
      TitleFont.Style = []
      TitlePixels = 90
      MessageStr = 'Codigo(s) do(s) representante(s)'
      TypeValue = tvString
      ValueNegative = False
      Decimals = 0
      CharUpperLower = False
    ...
    object EdFormato: TSQLEd
      ...
      TitleFont.Style = []
      TitlePixels = 90
      MessageStr = 'Nome do formato a ser usado'
      TypeValue = tvString
      ValueNegative = False
      Decimals = 0
      CharUpperLower = False
    ...
    object EdRepr_codigo: TSQLEd
      ...
      TitleFont.Style = []
      TitlePixels = 90
      MessageStr = 'Codigo do supervisor'
      TypeValue = tvInteger
      ValueNegative = False
      Decimals = 0
      ValueFormat = '###0'
