object FPesagemDevolucao: TFPesagemDevolucao
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Pesagem Devolu'#231#227'o de Mercadoria'
  ClientHeight = 630
  ClientWidth = 1144
  Color = clBtnFace
  ...
  object SQLPanelGrid1: TSQLPanelGrid
    ...
    object pbotoes: TSQLPanelGrid
      ...
      object bretnropedido: TSQLBtn
        ...
        Width = 180
        Height = 35
        Hint = 'retorna ao numero da nota'
        Caption = 'F3 - Cod. Cliente'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -19
      ...
      object bdevtotal: TSQLBtn
        Left = 2
        Top = 112
        Width = 166
        Height = 35
        Hint = 'Devolu'#231#227'o Total do Pedido'
      ...
      object SQLPanelGrid4: TSQLPanelGrid
        ...
        object PRemessa: TSQLPanelGrid
          ...
          object EdTipo_codigo: TSQLEd
            ...
            Text = ''
            Visible = True
            OnKeyDown = EdTipo_codigoKeyDown
            Empty = False
            CloseForm = False
            CloseFormEsc = False
            ShowForm = 'FCadcli'
            OnValidate = EdTipo_codigoValidate
            ColorFocus = clBlack
            ColorTextFocus = clWhite
            ColorNotEnabled = clGray
            ColorTextNotEnabled = clWhite
