...
procedure TfrmACBrDANFCeFortesFrETQdes.RLLabel3Beforerint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrETQdes.RLoteBeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
  Text := 'Lote '   + FormatFloat(',0', self.FACBrNFeDANFCeFortesA4.FpNFe.Ide.cNF) +
         '  - ' + FormatDateTime('dd/MM/yyyy', self.FACBrNFeDANFCeFortesA4.FpNFe.Ide.dEmi);
...
// 20.12.17 - somente pra etiqueta na embalagem desossa
  if self.FACBrNFeDANFCeFortesA4.FpNFe.Det.Items[0].Prod.nItem>1 then
    Text := FormatFloat(',0.00##', self.FACBrNFeDANFCeFortesA4.FpNFe.Det.Items[0].Prod.nItem)+' peças';
...
procedure TfrmACBrDANFCeFortesFrETQdes.RTextoPesoBeforePrint(
  Sender: TObject; var Text: String; var PrintIt: Boolean);
begin
   Text:='Peso';
end;
...
procedure TfrmACBrDANFCeFortesFrETQdes.REnderecoBeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
