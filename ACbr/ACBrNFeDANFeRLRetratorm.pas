...
uses
  ...
  jpeg,
    {$IFEND}
  {$ENDIF}
  ACBrNFeDANFeRLRM, pcnConversao, RLBarcode, StrUtils, DB;

type

  { TfrlDANFeRLRetrato }

  TfrlDANFeRLRetratoRM = class(TfrlDANFeRLRM)
    rlbEmitente: TRLBand;
    rliEmitente: TRLDraw;
    RLDraw6: TRLDraw;
    rliChave: TRLDraw;
...
procedure TfrlDANFeRLRetratoRM.RLNFeBeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
  q := 0;
...
procedure TfrlDANFeRLRetratoRM.rlbEmitenteBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfrlDANFeRLRetratoRM.InitDados;
var
...
procedure TfrlDANFeRLRetratoRM.Header;
var
...
procedure TfrlDANFeRLRetratoRM.Emitente;
var
...
procedure TfrlDANFeRLRetratoRM.Destinatario;
var
  sTep : String;
begin
  // destinatario
...
Function  TfrlDANFeRLRetratoRM.EnderecoEntrega : String;
begin
  Result := '';
...
Function TfrlDANFeRLRetratoRM.EnderecoRetirada : String;
begin
  Result := '';
...
procedure TfrlDANFeRLRetratoRM.Imposto;
var
...
procedure TfrlDANFeRLRetratoRM.Transporte;
var
...
procedure TfrlDANFeRLRetratoRM.DadosAdicionais;
var
...
procedure TfrlDANFeRLRetratoRM.Observacoes;
var
...
procedure TfrlDANFeRLRetratoRM.Itens;
var
  nItem : integer;
begin
...
procedure TfrlDANFeRLRetratoRM.ISSQN;
begin
...
procedure TfrlDANFeRLRetratoRM.AddFatura;
var
...
procedure TfrlDANFeRLRetratoRM.rlbItensAfterPrint(Sender: TObject);
var
  h: integer;
  str: WideString;
begin
...
procedure TfrlDANFeRLRetratoRM.rlbDadosAdicionaisBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfrlDANFeRLRetratoRM.rlbItensBeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
...
procedure TfrlDANFeRLRetratoRM.rlbEmitenteAfterPrint(Sender: TObject);
begin
  iItemAtual := 0;
end;

procedure TfrlDANFeRLRetratoRM.ConfigureDataSource;
begin
...
procedure TfrlDANFeRLRetratoRM.rlbCabecalhoItensBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfrlDANFeRLRetratoRM.FormCreate(Sender: TObject);
begin
  inherited;
...
Function TfrlDANFeRLRetratoRM.ManterVeiculos( inItem:  integer  ) : String;
begin
  Result := '';
...
Function TfrlDANFeRLRetratoRM.ManterMedicamentos( inItem:  integer ) : String;
Var
  i : Integer;
begin
  Result := '';
...
Function TfrlDANFeRLRetratoRM.ManterArma( inItem:  integer  ) : String;
Var
  i : Integer;
begin
  Result := '';
...
Function TfrlDANFeRLRetratoRM.ManterCombustivel( inItem:  integer  ) : String;
begin
  Result := '';
  with FNFe.Det.Items[inItem].Prod do
  begin
...
Function TfrlDANFeRLRetratoRM.ManterXpod( sXProd : String;  inItem : Integer ) : String;
begin
  Result := sXProd;
...
procedure TfrlDANFeRLRetratoRM.AddFaturaReal;
begin
...
Function TfrlDANFeRLRetratoRM.ManterDuplicatas : Integer;
Var
  x : Integer;
begin
  with FNFe.Cobr do
...
procedure TfrlDANFeRLRetratoRM.AplicaParametros;
var
  base: Integer;
