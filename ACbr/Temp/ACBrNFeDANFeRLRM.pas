...
uses
  ...
  {$ENDIF}
  pcnNFe, pcnConversao, ACBrNFe, ACBrNFeDANFeRLClassRM, ACBrUtil,
...
class procedure TfrlDANFeRLRM.Imprimir(AOwner: TComponent;
                ANFe: TNFe;
                ALogo: String;
                AMarcaDagua: String;
...
class procedure TfrlDANFeRLRM.SavePDF(AOwner: TComponent;
                ANFe: TNFe;
                ALogo: String;
                AMarcaDagua: String;
                ALarguraCodProd: Integer;
...
procedure TfrlDANFeRLRM.FormCreate(Sender: TObject);
begin
  {$IfNDef FPC}
   Self.Scaled := false;
...
procedure TfrlDANFeRLRM.ConfigureVariavies(ATipoDANFE: TpcnTipoImpressao);
begin
   case ATipoDANFE of
   tiRetrato    :  begin
                    iLimiteLinhas                := 10;
...
function TfrlDANFeRLRM.BuscaDireita(Busca, Text: String): Integer;
...
procedure TfrlDANFeRLRM.InsereLinhas(sTexto: String; iLimCaracteres: Integer;
                                                                 rMemo: TRLMemo);
...
function TfrlDANFeRLRM.QuebraLinha: String;
begin
...
function TfrlDANFeRLRM.ManterDesPro(dvDesc, dvProd: Double): Double;
begin
...
function TfrlDANFeRLRM.TrataDocumento(sCNPJCPF: String): String;
begin
  Result := sCNPJCPF;
