...
type
  ...
  TACBrNFeDANFCeFortesA4RM = class(TACBrNFeDANFEClass)
  private
    FpNFe: TNFe;
  ...
  TfrmACBrDANFCeFortesFrA4rm = class(TForm)
  ...
  private
    FNumItem: Integer;
    FNumPag: Integer;
    FACBrNFeDANFCeFortesA4: TACBrNFeDANFCeFortesA4RM;
...
function TfrmACBrDANFCeFortesFrA4rm.CompoemEnderecoCFe: String;
var
  Endereco, CEP: String;
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.FormCreate(Sender: TObject);
begin
  FACBrNFeDANFCeFortesA4          := TACBrNFeDANFCeFortesA4RM(Owner) ;  // Link para o Pai
...
procedure TfrmACBrDANFCeFortesFrA4rm.lNomeFantasiaBeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := self.FACBrNFeDANFCeFortesA4.FpNFe.Emit.xFant;
end;

procedure TfrmACBrDANFCeFortesFrA4rm.lSistemaBeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.PintarQRCode(QRCodeData: String;
  APict: TPicture);
var
...
procedure TfrmACBrDANFCeFortesFrA4rm.imgLogoBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLBand10BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLBand8BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  PrintIt := self.FACBrNFeDANFCeFortesA4.vTroco > 0;
end;

procedure TfrmACBrDANFCeFortesFrA4rm.rlbConsumidorBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  with self.FACBrNFeDANFCeFortesA4.FpNFe do
  begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.rlbRodapeBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  qrcode: String;
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel13BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := self.FACBrNFeDANFCeFortesA4.FpNFe.Det[self.FNumItem].Prod.cProd;
end;

procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel16BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel17BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel18BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel19BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel1BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := self.FACBrNFeDANFCeFortesA4.FpNFe.Emit.xNome;
end;

procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel20BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel22BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := FormatFloat(',0', self.FACBrNFeDANFCeFortesA4.FpNFe.Det.Count);
end;

procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel23BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel27BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel28BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel2BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := 'CNPJ: ' + FGeral.FormataCNPJ(self.FACBrNFeDANFCeFortesA4.FpNFe.Emit.CNPJCPF);
end;

procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel30BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel31BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel32BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel33BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := 'Número '   + FormatFloat(',0', self.FACBrNFeDANFCeFortesA4.FpNFe.Ide.cNF) +
          ' Série '   + FormatFloat('000', self.FACBrNFeDANFCeFortesA4.FpNFe.Ide.serie) +
          ' Emissão ' + FormatDateTime('dd/MM/yyyy hh:mm:ss', self.FACBrNFeDANFCeFortesA4.FpNFe.Ide.dEmi);
end;

procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel35BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel37BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel4BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel5BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLMemo1BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLMemo2BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := self.FACBrNFeDANFCeFortesA4.FpNFe.InfAdic.infCpl;
end;

procedure TfrmACBrDANFCeFortesFrA4rm.RLMemo3BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := CompoemEnderecoCFe;
end;

procedure TfrmACBrDANFCeFortesFrA4rm.rlReportA4DataRecord(Sender: TObject; RecNo,
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLSubDetail1DataRecord(Sender: TObject;
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLSubDetail2DataRecord(Sender: TObject;
  RecNo, CopyNo: Integer; var Eof: Boolean; var RecordAction: TRLRecordAction);
begin
  Eof := (RecNo > 1);
  RecordAction := raUseIt ;
...
procedure TfrmACBrDANFCeFortesFrA4rm.subItensDataRecord(Sender: TObject; RecNo,
  CopyNo: Integer; var Eof: Boolean; var RecordAction: TRLRecordAction);
begin
  FNumItem := RecNo - 1 ;
...
constructor TACBrNFeDANFCeFortesA4RM.Create(AOwner: TComponent);
begin
...
destructor TACBrNFeDANFCeFortesA4RM.Destroy;
begin

  inherited;
end;

procedure TACBrNFeDANFCeFortesA4RM.Imprimir(const DanfeResumido: Boolean; const AFiltro: TACBrNFeDANFCeFortesA4Filtro);
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var
  frACBrNFeDANFCeFortesFr: TfrmACBrDANFCeFortesFrA4rm;
  RLLayout: TRLReport;
...
begin
  ...
  frACBrNFeDANFCeFortesFr := TfrmACBrDANFCeFortesFrA4rm.Create(Self);
  try
...
procedure TACBrNFeDANFCeFortesA4RM.ImprimirDANFE(NFE: TNFe);
begin
  if NFe = nil then
   begin
...
procedure TACBrNFeDANFCeFortesA4RM.ImprimirDANFEPDF(NFE: TNFe);
begin
  if NFe = nil then
   begin
     if not Assigned(ACBrNFe) then
...
procedure TACBrNFeDANFCeFortesA4RM.ImprimirDANFEResumido(NFE: TNFe);
begin
  if NFe = nil then
   begin
     if not Assigned(ACBrNFe) then
...
procedure TACBrNFeDANFCeFortesA4RM.ImprimirDANFEResumidoPDF(NFE: TNFe);
begin
  if NFe = nil then
   begin
     if not Assigned(ACBrNFe) then
...
procedure TfrmACBrDANFCeFortesFrA4rm.rldescontodanfBeforePrint(Sender: TObject; var Text: String; var PrintIt: Boolean);
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel9BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel10BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel11BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel14BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel15BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel12BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RlDescontoBeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel24BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel25BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel26BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrA4rm.RLLabel29BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
