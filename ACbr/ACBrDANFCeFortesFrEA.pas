...
type
  ...
  TACBrNFeDANFCeFortesEA = class(TACBrNFeDANFEClass)
  private
    FpNFe: TNFe;
  ...
  TfrmACBrDANFCeFortesFrEA = class(TForm)
  ...
  private
    FNumItem: Integer;
    FNumPag: Integer;
    FACBrNFeDANFCeFortesA4: TACBrNFeDANFCeFortesEA;
...
function TfrmACBrDANFCeFortesFrEA.CompoemEnderecoCFe: String;
var
  Endereco, CEP: String;
begin
...
procedure TfrmACBrDANFCeFortesFrEA.FormCreate(Sender: TObject);
begin
  FACBrNFeDANFCeFortesA4          := TACBrNFeDANFCeFortesEA(Owner) ;  // Link para o Pai
...
procedure TfrmACBrDANFCeFortesFrEA.lNomeFantasiaBeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := self.FACBrNFeDANFCeFortesA4.FpNFe.Emit.xFant;
end;

procedure TfrmACBrDANFCeFortesFrEA.lSistemaBeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.PintarQRCode(QRCodeData: String;
  APict: TPicture);
var
...
procedure TfrmACBrDANFCeFortesFrEA.imgLogoBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLBand10BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLBand8BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
///  PrintIt := self.FACBrNFeDANFCeFortesA4.vTroco > 0;
end;

procedure TfrmACBrDANFCeFortesFrEA.rlbConsumidorBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
{
  with self.FACBrNFeDANFCeFortesA4.FpNFe do
...
procedure TfrmACBrDANFCeFortesFrEA.rlbRodapeBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  qrcode: String;
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel13BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := self.FACBrNFeDANFCeFortesA4.FpNFe.Det[self.FNumItem].Prod.cProd;
end;

procedure TfrmACBrDANFCeFortesFrEA.RLLabel16BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel17BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel18BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel19BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
   if self.FACBrNFeDANFCeFortesA4.FpNFe.pag.count>4 then
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel1BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
//  Text := self.FACBrNFeDANFCeFortesA4.FpNFe.Emit.xNome;
   if self.FACBrNFeDANFCeFortesA4.FpNFe.pag.count>1 then
     Text := FormatFloat(',0.00##', self.FACBrNFeDANFCeFortesA4.FpNFe.pag.Items[1].vPag);
end;

procedure TfrmACBrDANFCeFortesFrEA.RLLabel20BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel22BeorePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := FormatFloat(',0', self.FACBrNFeDANFCeFortesA4.FpNFe.Det.Count);
end;

procedure TfrmACBrDANFCeFortesFrEA.RLLabel23BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel27BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel28BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel2BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel30BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel31BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel32BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
   {
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel33BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel35BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel37BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel4BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel5BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
   if self.FACBrNFeDANFCeFortesA4.FpNFe.pag.count>1 then
...
procedure TfrmACBrDANFCeFortesFrEA.RLMemo1BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLMemo2BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := self.FACBrNFeDANFCeFortesA4.FpNFe.InfAdic.infCpl;
end;

procedure TfrmACBrDANFCeFortesFrEA.RLMemo3BeforePrint(Sender: TObject;
  var Text: string; var PrintIt: Boolean);
begin
  Text := CompoemEnderecoCFe;
end;

procedure TfrmACBrDANFCeFortesFrEA.rlReportA4DataRecord(Sender: TObject; RecNo,
...
procedure TfrmACBrDANFCeFortesFrEA.RLSubDetail1DataRecord(Sender: TObject;
...
procedure TfrmACBrDANFCeFortesFrEA.RLSubDetail2DataRecord(Sender: TObject;
  RecNo, CopyNo: Integer; var Eof: Boolean; var RecordAction: TRLRecordAction);
begin
  Eof := (RecNo > 1);
  RecordAction := raUseIt ;
...
procedure TfrmACBrDANFCeFortesFrEA.subItensDataRecord(Sender: TObject; RecNo,
  CopyNo: Integer; var Eof: Boolean; var RecordAction: TRLRecordAction);
begin
  FNumItem := RecNo - 1 ;
...
constructor TACBrNFeDANFCeFortesEA.Create(AOwner: TComponent);
begin
...
destructor TACBrNFeDANFCeFortesEA.Destroy;
begin

  inherited;
end;

procedure TACBrNFeDANFCeFortesEA.Imprimir(const DanfeResumido: Boolean; const AFiltro: TACBrNFeDANFCeFortesA4Filtro);
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var
  frACBrNFeDANFCeFortesFr: TfrmACBrDANFCeFortesFrEA;
  RLLayout: TRLReport;
...
begin
  ...
  frACBrNFeDANFCeFortesFr := TfrmACBrDANFCeFortesFrEA.Create(Self);
  try
...
procedure TACBrNFeDANFCeFortesEA.ImprimirDANFE(NFE: TNFe);
begin
  if NFe = nil then
   begin
...
procedure TACBrNFeDANFCeFortesEA.ImprimirDANFEPDF(NFE: TNFe);
begin
  if NFe = nil then
   begin
     if not Assigned(ACBrNFe) then
...
procedure TACBrNFeDANFCeFortesEA.ImprimirDANFEResumido(NFE: TNFe);
begin
  if NFe = nil then
   begin
     if not Assigned(ACBrNFe) then
...
procedure TACBrNFeDANFCeFortesEA.ImprimirDANFEResumidoPDF(NFE: TNFe);
begin
  if NFe = nil then
   begin
     if not Assigned(ACBrNFe) then
...
procedure TfrmACBrDANFCeFortesFrEA.rldescontodanfBeforePrint(Sender: TObject; var Text: String; var PrintIt: Boolean);
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel9BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel10BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel11BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel14BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel15BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
   if self.FACBrNFeDANFCeFortesA4.FpNFe.pag.count>3 then
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel12BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RlDescontoBeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel24BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel25BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel26BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.RLLabel29BeforePrint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
...
procedure TfrmACBrDANFCeFortesFrEA.rlReportA4AfterPrint(Sender: TObject);
begin
//     #27+'w'
//  #27 + #119;   w
...
procedure TfrmACBrDANFCeFortesFrEA.lEnderecoConsumidorBeforePrint(
  Sender: TObject; var Text: String; var PrintIt: Boolean);
begin
   Text:=#27 + #119;
end;

procedure TfrmACBrDANFCeFortesFrEA.RLLabel3Beforerint(Sender: TObject;
  var Text: String; var PrintIt: Boolean);
begin
