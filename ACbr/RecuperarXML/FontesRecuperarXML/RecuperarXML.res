...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  <head>
    ...
    <title>
  Componentes ACBr / Code /
  [r8242]
  /tags/Projetos/RecuperarXML/RecuperarXML.res
</title>
    
<meta id="webtracker" name="webtracker" content='{&#34;event_id&#34;: &#34;abde4b2e-a3f9-11e4-b6f5-0200ac1d2938&#34;, &#34;project&#34;: &#34;acbr&#34;, &#34;action_type&#34;: &#34;svn&#34;}' />

<script src="http://a.fsdn.com/allura/nf/1421965932/_ew_/theme/sftheme/js/sftheme/modernizr.custom.90514.js"></script>

<script src="http://a.fsdn.com/allura/nf/1421965932/_ew_/theme/sftheme/js/sftheme/jquery-1.8.0.min.js"></script>

<script src="http://a.fsdn.com/allura/nf/1421965932/_ew_/theme/sftheme/js/sftheme/header.js"></script>
<!--[if lt IE 7 ]>
  <script src="http://a.fsdn.com/allura/nf/1421965932/_ew_/theme/sftheme/js/sftheme/dd_belatedpng.js"></script>
...
<style type="text/css">
    @font-face {
        font-family: "Pictos";
        src: url('http://a.fsdn.com/allura/nf/1421965932/_ew_/theme/sftheme/css/fonts/sftheme/pictos-web.eot');
        src: local("☺"), url('http://a.fsdn.com/allura/nf/1421965932/_ew_/theme/sftheme/css/fonts/sftheme/pictos-web.woff') format('woff'), url('http://a.fsdn.com/allura/nf/1421965932/_ew_/theme/sftheme/css/fonts/sftheme/pictos-web.ttf') format('truetype'), url('http://a.fsdn.com/allura/nf/1421965932/_ew_/theme/sftheme/css/fonts/sftheme/pictos-web.svg') format('svg');
    }
</style>
    <script type="text/javascript">
      ...
      <link rel="stylesheet"
                type="text/css"
                href="http://a.fsdn.com/allura/nf/1421965932/_ew_/_slim/css?href=allura%2Fcss%2Fforge%2Fhilite.css"
                >
    
      <link rel="stylesheet"
                type="text/css"
                href="/nf/tool_icon_css?1421965932"
                >
    
      <link rel="stylesheet"
                type="text/css"
                href="http://a.fsdn.com/allura/nf/1421965932/_ew_/theme/sftheme/css/forge.css"
                >
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/rss+xml" title="RSS" href="/p/acbr/code/feed.rss"/>
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/acbr/code/feed.atom"/>

      <style>.XKxZzLewWnzKSpzOtFsDWQ { display:none }</style>
...
<header id="site-sec-header">
    ...
    <section id="page-body" class=" neighborhood-Projects project-acbr mountpoint-code">
    ...
    <nav id="breadcrumbs">
        <ul>
            ...
            <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="/directory">Browse</a></li>
                ...
                <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="/p/acbr/">Componentes ACBr</a></li>
      ...
      <img src="/p/acbr//icon?2013-06-05 13:39:52+00:00" class="project_icon" alt="Project Logo">
    
    <h1 class="project_title">
        <a href="/p/acbr/" class="project_link">Componentes ACBr</a>
    </h1>
    ...
    <div class="brought-by with-icon">
        Brought to you by:
                ...
                <a href="/u/anfm/">anfm</a>,
            
            
                <a href="/u/dopi/">dopi</a>
            </div>
...
<ul class="dropdown">
    ...
    <li class="">
        <a href="/projects/acbr/" class="ui-icon-tool-summary-32">
            Summary
        </a>
    ...
    <li class="">
        <a href="/projects/acbr/files/" class="ui-icon-tool-files-32">
            Files
        </a>
    ...
    <li class="">
        <a href="/projects/acbr/reviews" class="ui-icon-tool-reviews-32">
            Reviews
        </a>
    ...
    <li class="">
        <a href="/projects/acbr/support" class="ui-icon-tool-support-32">
            Support
        </a>
    ...
    <li class="">
        <a href="/p/acbr/wiki/" class="ui-icon-tool-wiki-32">
            Wiki
        </a>
    ...
    <li class="">
        <a href="/p/acbr/news/" class="ui-icon-tool-blog-32">
            News
        </a>
    ...
    <li class="selected">
        <a href="/p/acbr/code/" class="ui-icon-tool-svn-32">
            Code
        </a>
...
<div id="sidebar">
    ...
    <li>
      <a href="/p/acbr/code/commit_browser"><b data-icon="o" class="ico ico-folder"></b> <span>Browse Commits</span></a>
    </li>
        ...
        <div class="grid-20 pad">
          <h2 class="dark title">
<a href="/p/acbr/code/8242/">[r8242]</a>:
...
<a href="/p/acbr/code/8242/log/?path=/tags/Projetos/RecuperarXML/RecuperarXML.res">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <p>RecuperarXML.res is not known to be viewable in your browser.
...
<footer id="site-copyright-footer">
    <div class="wrapper">
        <div id="copyright">
            Copyright &copy; 2015 SourceForge. All Rights Reserved.<br />
...
<script type="text/javascript">(function() {
  ...
  if (repo_status) {
    ...
    function check_status() {
        $.get('/p/acbr/code/status', function(data) {
