...
// 20.08.20
  GridRateio.cells[Gridrateio.GetColumn('valor'),GridRateio.row]:=currtostr( EdValor.Ascurrency );
  GridRateio.setfocus;
...
begin
  ...
  if condicao  then begin
    ...
    Avisoerro(' Soma dos valores informados difere do total de produtos da nota');
    canclose:=false;
