object FCopas: TFCopas
  Left = 330
  Top = 188
  BorderStyle = bsDialog
  Caption = 'Cadastro de Copas'
  ClientHeight = 354
  ClientWidth = 483
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdCopa_codigo: TSQLEd
          ...
          Table = Arq.TCopas
          TableName = 'copas'
          TableField = 'Copa_codigo'
          PanelMessages = PMens
        end
        object EdCopa_descricao: TSQLEd
          Left = 79
          Top = 16
          Width = 250
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdCopa_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Descri'#231#227'o da copa'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o da copa'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
