...
begin
   ...
   if Q.eof then begin
    ...
    FRel.AddTit('Relatório de Créditos de Pis/Cofins');
    ...
    FRel.AddCol(090,1,'C','' ,''              ,'Per.Ap.Crédito'            ,''         ,'',false);
    FRel.AddCol(070,1,'C','' ,''              ,'Orig.Créd.'            ,''         ,'',false);
    FRel.AddCol(070,1,'C','' ,''              ,'Tipo Créd.'            ,''         ,'',false);
    FRel.AddCol(120,1,'C','' ,''              ,'Cnpj Créd.'            ,''         ,'',false);

    FRel.AddCol(090,3,'N','' ,''              ,'Vlr Créd.Ap.'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Vlr Créd.Ext.Ap.'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Vlr Tot Créd.Ap.'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Vlr Créd.Ut.Des.'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Créd.Ut.Ressarc.'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Créd.Ut.Compens.'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Saldo Créd.Disp.'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Créd.Desc.Per.'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Créd.Obj.Ped.'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Créd.Ut.Comp.Per'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Créd.Transferido'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Créd.Ut.Outras F.'            ,''         ,'',false);
    FRel.AddCol(090,3,'N','' ,''              ,'Saldo Créd. a Ut.'            ,''         ,'',false);
