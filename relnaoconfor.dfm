object FRelNaoConf: TFRelNaoConf
  Left = 392
  Top = 193
  BorderStyle = bsDialog
  Caption = 'Relat'#243'rios de N'#227'o Conformidade'
  ClientHeight = 376
  ClientWidth = 522
  Color = clBtnFace
  ...
  object PRel: TSQLPanelGrid
    ...
    object EdPendentes: TSQLEd
      ...
      TitleFont.Style = []
      TitlePixels = 90
      MessageStr = 'S - Pendentes    N - Encerradas   A - Ambas'
      TypeValue = tvString
      ValueNegative = False
      Decimals = 0
      CharUpperLower = False
    ...
    object EdNumerodoc: TSQLEd
      ...
      TitleFont.Style = []
      TitlePixels = 90
      MessageStr = 'Numero do plano de a'#231#227'o'
      TypeValue = tvInteger
      ValueNegative = False
      Decimals = 0
      ValueFormat = '###,##0'
    ...
    object EdUsua_codigo: TSQLEd
      ...
      TitleFont.Style = []
      TitlePixels = 90
      MessageStr = 'C'#243'digo do usu'#225'rio respons'#225'vel'
      TypeValue = tvInteger
      ValueNegative = False
      Decimals = 0
      ValueFormat = '###,##0'
    ...
    object EdEncerrai: TSQLEd
      ...
      TitleFont.Style = []
      TitlePixels = 90
      MessageStr = 'Data inicial do per'#237'odo de encerramento'
      TypeValue = tvDate
      ValueNegative = False
      Decimals = 0
      CharUpperLower = False
    ...
    object EdEncerraf: TSQLEd
      ...
      TitleFont.Style = []
      TitlePixels = 20
      MessageStr = 'Data final do per'#237'odo de encerramento'
      TypeValue = tvDate
      ValueNegative = False
      Decimals = 0
      CharUpperLower = False
