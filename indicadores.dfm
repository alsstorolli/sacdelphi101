    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdIndi_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Codigo do indicador'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TIndicadores
          TableName = 'indicadores'
          TableField = 'Indi_codigo'
          PanelMessages = PMens
        end
        object EdIndi_descricao: TSQLEd
          Left = 65
          Top = 24
          Width = 250
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o do indicador'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TIndicadores
          TableName = 'indicadores'
          TableField = 'Indi_descricao'
          PanelMessages = PMens
        end
        object EdIndi_usua_codigo: TSQLEd
          Left = 275
          Top = 38
          Width = 50
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Usu'#225'rio que incluiu/alterou o cadastro do indicador'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          ...
          Table = Arq.TIndicadores
          TableName = 'indicadores'
          TableField = 'Indi_usua_codigo'
          PanelMessages = PMens
        end
        object EdIndi_usua_resp: TSQLEd
          Left = 325
          Top = 24
          Width = 50
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Usu'#225'rio respons'#225'vel pelo indicador'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          ...
          Table = Arq.TIndicadores
          TableName = 'indicadores'
          TableField = 'Indi_usua_resp'
          PanelMessages = PMens
        end
        object EdIndi_diainfo: TSQLEd
          Left = 384
          Top = 24
          Width = 35
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Dia para informar indicador ( 0 para n'#227'o informar )'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          ...
          Table = Arq.TIndicadores
          TableName = 'indicadores'
          TableField = 'Indi_diainfo'
          PanelMessages = PMens
        end
        object EdIndi_unidade: TSQLEd
          Left = 428
          Top = 24
          Width = 40
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdIndi_usua_respExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'indi_usua_resp'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'indi_diainfo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'indi_unidade'
            Visible = True
          end>
      end
    end
