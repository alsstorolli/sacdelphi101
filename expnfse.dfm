object FExpNfse: TFExpNfse
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Envio XML Notas de Servi'#231'os'
  ClientHeight = 534
  ClientWidth = 934
  Color = clBtnFace
  ...
  object PCadastro: TPanel
    ...
    object PBotoes: TSQLPanelGrid
      ...
      object bgerenciar: TSQLBtn
        ...
        Width = 95
        Height = 25
        Hint = 'atalho para gerenciamento das NFSe'
        Caption = '&Gerenciar NFSe'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
      ...
      object bconsultapref: TSQLBtn
        Left = 3
        Top = 163
        Width = 95
        Height = 25
        Hint = 'Consulta situa'#231#227'o RPS enviado'
        Caption = '&Consulta RPS'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
    ...
    object Panel1: TPanel
      ...
      object Edformaemissao: TSQLEd
        ...
        CloseForm = False
        CloseFormEsc = False
        OnExitEdit = EdformaemissaoExitEdit
        ColorFocus = clBlack
        ColorTextFocus = clWhite
        ColorNotEnabled = clGray
        ColorTextNotEnabled = clWhite
      ...
      object EdExportadas: TSQLEd
        ...
        TitleFont.Style = []
        TitlePixels = 0
        MessageStr = 'Envia conhecimentos n'#227'o exportadas, exportadas ou ambas'
        TypeValue = tvString
        ValueNegative = False
        Decimals = 0
        CharUpperLower = False
      ...
      object EdNotas: TSQLEd
        ...
        TitleFont.Style = []
        TitlePixels = 0
        MessageStr = 'Conhecimentos a serem exportadas'
        TypeValue = tvString
        ValueNegative = False
        Decimals = 0
        CharUpperLower = False
