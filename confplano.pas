...
type
  TFConfPlano = class(TForm)
    ...
    SQLEd9: TSQLEd;
    Edplan_ctaapropriar01: TSQLEd;
    Edplan_ctaapropriar02: TSQLEd;
...
// 15.07.20
  campo:=Sistema.GetDicionario(FConfPlano.Edplan_ctaapropriar01.TableName,FConfPlano.Edplan_ctaapropriar01.TableField);
  if campo.Tipo<>'' then begin

    FConfPlano.Edplan_ctaapropriar01.enabled:=true;
    FConfPlano.Edplan_ctaapropriar02.enabled:=true;

  end else begin

    FConfPlano.Edplan_ctaapropriar01.enabled:=false;
    FConfPlano.Edplan_ctaapropriar02.enabled:=false;
