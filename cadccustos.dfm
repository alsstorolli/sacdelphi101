    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdCcst_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo do centro de custos'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          ...
          Table = Arq.TCCustos
          TableName = 'CCUSTOS'
          TableField = 'Ccst_codigo'
          PanelMessages = PMens
        end
        object EdCcst_descricao: TSQLEd
          Left = 70
          Top = 20
          Width = 250
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o do centro de custos'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TCCustos
          TableName = 'CCUSTOS'
          TableField = 'Ccst_descricao'
          PanelMessages = PMens
        end
        object EdCcst_reduzido: TSQLEd
          Left = 324
          Top = 20
          Width = 100
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdCcst_reduzidoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o reduzida do centro de custos'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'ccst_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'ccst_descricao'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'ccst_reduzido'
            Visible = True
          end>
      end
    end
