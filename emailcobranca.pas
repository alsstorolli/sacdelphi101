...
begin
   ...
   if NaoEnviados.Count=0 then
       ...
       Sistema.EndProcess('Email(s) NÃO enviado(s): '+NaoEnviados.Text);
...
begin
    ...
    if QPedidos.eof then begin
      Avisoerro('Não encontrado documentos em aberto no periodo OU clientes que permitiram enviar email');
      Edvenfinal.setfocus;
    end else begin
