...
// 30.09.2021 - Clessi
         ...
         result:='55';
// 08.12.2021  - Começou a importar xml de serviços com chave...
...
///////////////////////////////////////////////////////
    begin
      ...
      if ycst='000' then
        result:=sticmsTributadaIntegralmente
      else if ycst='010'  then //	Tributada e com cobrança do ICMS por substituição tributária
        result:=sticmsTributadaComCobracaPorST
      else if ycst='020'  then //	Com redução de base de cálculo
        result:=sticmsComReducao
      else if ycst='030' then  //	Isenta ou não tributada e com cobrança do ICMS por substituição tributária
        result:=sticmsIsentaComCobracaPorST
      else if ycst='040' then //	Isenta
        result:=sticmsIsenta
      else if ycst='041' then //	Não tributada
        result:=sticmsNaoTributada
      else if ycst='050' then //	Suspensão
        result:=sticmsSuspensao
      else if ycst='051' then //	Diferimento
        result:=sticmsDiferimento
      else if ycst='060' then //	ICMS cobrado anteriormente por substituição tributária
        result:=sticmsCobradoAnteriormentePorST
      else if ycst='070' then //	Com redução de base de cálculo e cobrança do ICMS por substituição tributária
        result:=sticmsComReducaoPorST
      else if ycst='090' then //	Outros
        result:=sticmsOutros
      else if ycst='100' then // Estrangeira - Importação direta - Tributada integralmente
        result:=sticmsEstrangeiraImportacaoDiretaTributadaIntegralmente
      else if ycst='110' then // Estrangeira - Importação direta - Tributada e com cobrança do ICMS por substituição tributária
        result:=sticmsEstrangeiraImportacaoDiretaTributadaComCobracaPorST

      else if ycst='120' then // Estrangeira - Importação direta - Com redução de base de cálculo
        result:=sticmsEstrangeiraImportacaoDiretaComReducao

      else if ycst='130' then // Estrangeira - Importação direta - Isenta ou não tributada e com cobrança do ICMS por substituição tributária
        result:=sticmsEstrangeiraImportacaoDiretaIsentaComCobracaPorST

      else if ycst='140' then // Estrangeira - Importação direta - Isenta
        result:=sticmsEstrangeiraImportacaoDiretaIsenta

      else if ycst='141' then // Estrangeira - Importação direta - Não tributada
        result:=sticmsEstrangeiraImportacaoDiretaNaoTributada

      else if ycst='150' then // Estrangeira - Importação direta - Suspensão
        result:=sticmsEstrangeiraImportacaoDiretaSuspensao

      else if ycst='151' then // Estrangeira - Importação direta - Diferimento
        result:=sticmsEstrangeiraImportacaoDiretaDiferimento

      else if ycst='160' then // Estrangeira - Importação direta - ICMS cobrado anteriormente por substituição tributária
        result:=sticmsEstrangeiraImportacaoDiretaCobradoAnteriormentePorST

      else if ycst='170' then // Estrangeira - Importação direta - Com redução de base de cálculo e cobrança do ICMS por substituição tributária
        result:=sticmsEstrangeiraImportacaoDiretaComReducaoPorST

      else if ycst='190' then // Estrangeira - Importação direta - Outras
      ...
      else if ycst='210' then // Estrangeira - Adquirida no mercado interno - Tributada e com cobrança do ICMS por substituição tributária
        result:=sticmsEstrangeiraAdqMercIntTributadaComCobracaPorST

      else if ycst='220' then // Estrangeira - Adquirida no mercado interno - Com redução de base de cálculo
        result:=sticmsEstrangeiraAdqMercIntComReducao

      else if ycst='230' then // Estrangeira - Adquirida no mercado interno - Isenta ou não tributada e com cobrança do ICMS por substituição tributária
      ...
      else if ycst='241' then // Estrangeira - Adquirida no mercado interno - Não tributada
        result:=sticmsEstrangeiraAdqMercIntNaoTributada

      else if ycst='250' then // Estrangeira - Adquirida no mercado interno - Suspensão
      ...
      else if ycst='260' then // Estrangeira - Adquirida no mercado interno - ICMS cobrado anteriormente por substituição tributária
        result:=sticmsEstrangeiraAdqMercIntCobradoAnteriormentePorST

      else if ycst='270' then // Estrangeira - Adquirida no mercado interno - Com redução de base de cálculo e cobrança do ICMS por substituição tributária
      ...
      else if ycst='101' then // Simples Nacional - Tributada pelo Simples Nacional com permissão de crédito
      ...
      else if ycst='102' then // Simples Nacional - Tributada pelo Simples Nacional sem permissão de crédito
        result:=sticmsSimplesNacionalTributadaSemPermissaoCredito

      else if ycst='103' then // Simples Nacional - Isenção do ICMS no Simples Nacional para faixa de receita bruta
        result:=sticmsSimplesNacionalIsencaoPorFaixaReceitaBruta

      else if ycst='102' then // Simples Nacional - Tributada pelo Simples Nacional sem permissão de crédito
        result:=sticmsSimplesNacionalTributadaSemPermissaoCredito

      else if ycst='201' then // Simples Nacional - Tributada pelo Simples Nacional com permissão de crédito e com cobrança do ICMS por substituição tributária
        result:=sticmsSimplesNacionalTributadaComPermissaoCreditoComST

      else if ycst='202' then // Simples Nacional - Tributada pelo Simples Nacional sem permissão de crédito e com cobrança do ICMS por substituição tributária
      ...
      else if ycst='203' then // Simples Nacional - Isenção do ICMS no Simples Nacional para faixa de receita bruta e com cobrança do ICMS por substituição tributária
      ...
      else if ycst='400' then // Simples Nacional - Não tributada pelo Simples Nacional
        result:=sticmsSimplesNacionalNaoTributada

      else if ycst='500' then // Simples Nacional - ICMS cobrado anteriormente por substituição tributária (substituído) ou por antecipação
...
// 17.10.17
    ...
    begin
      ...
      if ( Global.Usuario.Codigo=100 ) and ( result='' ) then
           Texto.LInes.Add('Reduzido '+inttostr(xcontareduzida)+' não encontrado no plano de contas');
...
// 17.10.17
    ...
    var QP:TSqlquery;
        whereempresa:string;
    begin
// 12.01.18 - no sac unidade 003 porem na contab empresa 01...devido a mudança de
//            capeg para vidanova
...
// 15.12.16
  if not FGeral.ConectaContax then begin
     Avisoerro('Não foi possível conectar com a contabilidade. Registro 0500 não será gerado !!');
//     exit;
  end;
// 13.02.19 - Vida Nova
...
// 19.10.18 - retirado
  ...
  if not confirma('Confirma geração do arquivo do Sped Fiscal ref. Pis/Cofins ?') then exit;
...
/////////////////////////////////
// 09.04.12 - pois conhecimento entrada não é digitado itens então gero aqui com cst 'fixo' 54  -> 53
// até ver como tratar de forma 'configurável'
         if Es='E' then begin
...
// aos 'sumiços de codigos' de 2010/2011
                ' inner join natureza on (natf_codigo=moes_natf_codigo)'+
...
// 14.05.12 - Capeg - cfops pra não enviar
                sqlcfopssim+
...
// 09.03.12
  ...
  if Q.eof then begin
    Avisoerro('Nada encontrado para exportação.  Será gerado SEM movimento para a unidade '+QUnidades.fieldbyname('Unid_codigo').asstring);
  end;
...
//      LimpaRegistros;
      ...
      with RegistroC010New do begin
        CNPJ:=QUnidades.fieldbyname('unid_cnpj').asstring;
        IND_ESCRI:=IndEscriIndividualizado;  //2 – Apuração com base no registro individualizado de NF-e (C100 e C170) e de ECF (C400)
...
// 29.10.18 - enviar todos ref. serviços - Novicarnes - Ketlen
...
// 20.10.17 - Novicarnes - nf de entrada de serviços ficam zeradas pois nao tem base de iss
...
// 07.11.18 - Novicarnes - Ketlen
                if (valorpis+valorcofins) >0 then begin
                  ...
                  if Q.fieldbyname('moes_baseiss').ascurrency>0 then begin
                    VL_BC_PIS:=Q.fieldbyname('moes_baseiss').ascurrency;  // confirmar se a base é o total da nota mesmo...
...
// 26.10.16 - nota de credito de icms q só tem valor do icms e demais campos zerados - sped contrib.
...
//checar - ver se cria função para buscar pela transacao+tipo de movimento
...
//            mas é informado para efeito de custo
              if ( (Q.fieldbyname('moes_totprod').ascurrency+Q.fieldbyname('moes_valoripi').ascurrency+
                  Q.fieldbyname('moes_valoricmssutr').ascurrency+vlrfrete) > Q.fieldbyname('moes_vlrtotal').ascurrency )
                  and ( Es = 'E' )
                   then
...
// 09.04.12 - conhecimento de entrada não é digitado itens...rever... nem passa por aqui
...
{   // só gerar se usar o campo de informacoes complementares de nao de informacoes
//     adicionais
...
// checar se for entrada com cfop começado por '3' - importação gerar o registro
// C120
{
...
// 23.01.20
          ...
          if vlrdesco<0 then Texto.Lines.Add(' Transação '+Q.FieldByName('moes_transacao').AsString+
...
// 05.07.10 - 17.12.10 - sped fiscal
     if (  copy(Q.FieldByName('moes_serie').asstring,1,1)='D' ) and ( pos(copy(Q.FieldByName('moes_natf_codigo').asstring,1,1),'567')>0 ) then begin
// nota fiscal de venda consumidor ( modelo 02 ) série D ....
// C380...
...
//  25.01.11 - nao entendi este cod_nat se é mesmo igual ao cfop
...
// criar campo cadastro de unidades pra identifcar se é contribuiente do IPI
...
//                   PC170.CST_COFINS:=GetCSTCOFINS( FCodigosipi.GetCstCofins( FEstoque.GetcodigoIPINCM(Q.fieldbyname('move_esto_codigo').asstring ) ) );
                     if Q.FieldByName('moes_plan_codigo').AsInteger  >0 then begin
                         ...
                         if LIstaDespesasCST53.IndexOf( IntToStr( Q.FieldByName('moes_plan_codigo').AsInteger ) ) >=0  then begin
                           ...
                           PC170.CST_PIS    := GetCSTPIS( FCodigosipi.GetCstPis( FEstoque.GetcodigoIPINCM(Q.fieldbyname('move_esto_codigo').asstring ) ) );
                           PC170.CST_COFINS := GetCSTCOFINS( FCodigosipi.GetCstCofins( FEstoque.GetcodigoIPINCM(Q.fieldbyname('move_esto_codigo').asstring ) ) );
// 06.08.19 - Novicarnes - Ketlen - diferenciação cfe a conta de despesa
...
// checar se pode ser 'pego' através da config. de movimento...
//             PC170.COD_CTA:='000';
//  18.10.17
...
// 29.10.18 - Novicarnes - ketlen
            ...
            with AcbrSpedPisCofins1.Bloco_A do begin
              ...
              with RegistroA170New do begin
                 ...
                 VL_ITEM:=totalitem;
                 VL_DESC:=vlrdesco;
// 20.03.18 - Novicarnes - Ketlen contadora nao preencher quando serviço prestado
...
// 26.04.19 - Novicarnes - Ketlen - diferenciação cfe a conta de despesa
                           if campo.Tipo<>'' then begin
                              cstpiscofins:=FPlano.GetCSTPisCofins( Q.FieldByName('moes_plan_codigo').AsInteger);
                              if trim(cstpiscofins)<>'' then begin
...
// fatura de energia elétrica
//////////////////////////////
//////////////// C501 - 'item' de energia elétrica  - ref. PIS
...
////////////////
//////////////// C505 - 'item' de energia elétrica  - ref. Cofins
...
// como gero o registro 100 nao é necessario informar C180/C190 é opcional
/////////////////////////////////////////////////////////////////////////////////
{
    for p:=0 to ListaDocumentoCst.Count-1 do begin
       PDocumentoCst:=ListaDocumentoCst[p];
...
// senao o validador dá advertencia para cst ?20,?70 // 23.02.11
...
// ver se é somente codigo de barra 'oficial' ou pode ser de uso interno tbem
...
//            não é o mesmo usado pelo sped contribuicoes
...
//               COD_LST:=
             ...
             Avisoerro('Codigo '+cod_item+' não encontrado no estoque');
         end;
       end;
...
//         ( PRegD201205.Numerodoc<=PRegD200.NUM_DOC_FIM )
         then begin
// aqui ao inves de percorrer ja somar em o que tá no D201 cfe data e numero inicial e final
...
// 13.12.19  - Novicarnes - Ketlen  - mudada de posição 'antes' em 13.07.20
...
//       para identifcar se é cooperativa, empresarial ou com pis exclusivo sobre a folha
...
// o jamanta..só gerar se usar o campo de informaçoes complementares
///////////////////////////////////////////////////////////////////////
...
//           no registro 300 que por sua vez só informa os bens já inclusos e 'movimentados' no
//           periodo e que são informados no Bloco G regisgro G125
///////////////////////////////////////////////////////////////////////
...
//      result:=stpisValorAliquotaNormal;
      if ycst='01' then
        result:=stpisValorAliquotaNormal // Operação Tributável com Alíquota Básica   // valor da operação alíquota normal (cumulativo/não cumulativo)).
      else if ycst='02' then
        result:=stpisValorAliquotaDiferenciada     // '02' // Operação Tributável com Alíquota Diferenciada // valor da operação (alíquota diferenciada)).
      else if ycst='03' then
        result:=stpisQtdeAliquotaUnidade           // '03' // Operação Tributável com Alíquota por Unidade de Medida de Produto // quantidade vendida x alíquota por unidade de produto).
      else if ycst='04' then
        result:=stpisMonofaticaAliquotaZero        // '04' // Operação Tributável Monofásica - Revenda a Alíquota Zero
      else if ycst='05' then
        result:=stpisValorAliquotaPorST            // '05' // Operação Tributável por Substituição Tributária
      else if ycst='06' then
        result:=stpisAliquotaZero                  // '06' // Operação Tributável a Alíquota Zero
      else if ycst='07' then
        result:=stpisIsentaContribuicao            // '07' // Operação Isenta da Contribuição
      else if ycst='08' then
        result:=stpisSemIncidenciaContribuicao     // '08' // Operação sem Incidência da Contribuição
      else if ycst='09' then
        result:=stpisSuspensaoContribuicao         // '09' // Operação com Suspensão da Contribuição
      else if ycst='49' then
        result:=stpisOutrasOperacoesSaida          // '49' // Outras Operações de Saída
      else if ycst='50' then
        result:=stpisOperCredExcRecTribMercInt     // '50' // Operação com Direito a Crédito - Vinculada Exclusivamente a Receita Tributada no Mercado Interno
      else if ycst='51' then
        result:=stpisOperCredExcRecNaoTribMercInt  // '51' // Operação com Direito a Crédito – Vinculada Exclusivamente a Receita Não Tributada no Mercado Interno
      else if ycst='52' then
        result:=stpisOperCredExcRecExportacao      // '52' // Operação com Direito a Crédito - Vinculada Exclusivamente a Receita de Exportação
      else if ycst='53' then
        result:=stpisOperCredRecTribNaoTribMercInt // '53' // Operação com Direito a Crédito - Vinculada a Receitas Tributadas e Não-Tributadas no Mercado Interno
      else if ycst='54' then
        result:=stpisOperCredRecTribMercIntEExportacao // '54' // Operação com Direito a Crédito - Vinculada a Receitas Tributadas no Mercado Interno e de Exportação
      else if ycst='55' then
        result:=stpisOperCredRecNaoTribMercIntEExportacao // '55' // Operação com Direito a Crédito - Vinculada a Receitas Não-Tributadas no Mercado Interno e de Exportação
      else if ycst='56' then
        result:=stpisOperCredRecTribENaoTribMercIntEExportacao // '56' // Operação com Direito a Crédito - Vinculada a Receitas Tributadas e Não-Tributadas no Mercado Interno, e de Exportação
      else if ycst='60' then
        result:=stpisCredPresAquiExcRecTribMercInt      // '60' // Crédito Presumido - Operação de Aquisição Vinculada Exclusivamente a Receita Tributada no Mercado Interno
      else if ycst='61' then
        result:=stpisCredPresAquiExcRecNaoTribMercInt   // '61' // Crédito Presumido - Operação de Aquisição Vinculada Exclusivamente a Receita Não-Tributada no Mercado Interno
      else if ycst='62' then
        result:=stpisCredPresAquiExcExcRecExportacao    // '62' // Crédito Presumido - Operação de Aquisição Vinculada Exclusivamente a Receita de Exportação
      else if ycst='63' then
        result:=stpisCredPresAquiRecTribNaoTribMercInt    // '63' // Crédito Presumido - Operação de Aquisição Vinculada a Receitas Tributadas e Não-Tributadas no Mercado Interno
      else if ycst='64' then
        result:=stpisCredPresAquiRecTribMercIntEExportacao // '64' // Crédito Presumido - Operação de Aquisição Vinculada a Receitas Tributadas no Mercado Interno e de Exportação
      else if ycst='65' then
        result:=stpisCredPresAquiRecNaoTribMercIntEExportacao  // '65' // Crédito Presumido - Operação de Aquisição Vinculada a Receitas Não-Tributadas no Mercado Interno e de Exportação
      else if ycst='66' then
        result:=stpisCredPresAquiRecTribENaoTribMercIntEExportacao  // '66' // Crédito Presumido - Operação de Aquisição Vinculada a Receitas Tributadas e Não-Tributadas no Mercado Interno, e de Exportação
      else if ycst='67' then
        result:=stpisOutrasOperacoes_CredPresumido       // '67' // Crédito Presumido - Outras Operações
      else if ycst='70' then
        result:=stpisOperAquiSemDirCredito               // '70' // Operação de Aquisição sem Direito a Crédito
      else if ycst='71' then
        result:=stpisOperAquiComIsensao                // '71' // Operação de Aquisição com Isenção
      else if ycst='72' then
        result:=stpisOperAquiComSuspensao              // '72' // Operação de Aquisição com Suspensão
      else if ycst='73' then
        result:=stpisOperAquiAliquotaZero              // '73' // Operação de Aquisição a Alíquota Zero
      else if ycst='74' then
        result:=stpisOperAqui_SemIncidenciaContribuicao    // '74' // Operação de Aquisição sem Incidência da Contribuição
      else if ycst='75' then
        result:=stpisOperAquiPorST                    // '75' // Operação de Aquisição por Substituição Tributária
      else if ycst='98' then
        result:=stpisOutrasOperacoesEntrada          // '98' // Outras Operações de Entrada
      else // if ycst='99' then
        result:=stpisOutrasOperacoes;      // '99' // Outras Operações   // 14.03.16
...
function TFSpedPisCofins.GetCSTCOFINS(ycst:string;ycfop:string='';ycsticms:string=''):TACBrSituacaoTribCOFINS;
    ...
    begin
      ...
      if ycst='01' then
        result:=stcofinsValorAliquotaNormal          // '01' // Operação Tributável com Alíquota Básica                           // valor da operação alíquota normal (cumulativo/não cumulativo)).
      else if ycst='02' then
        result:=stcofinsValorAliquotaDiferenciada    // '02' // Operação Tributável com Alíquota Diferenciada                     // valor da operação (alíquota diferenciada)).
      else if ycst='03' then
        result:=stcofinsQtdeAliquotaUnidade          // '03' // Operação Tributável com Alíquota por Unidade de Medida de Produto // quantidade vendida x alíquota por unidade de produto).
      else if ycst='04' then
        result:=stcofinsMonofaticaAliquotaZero         // '04' // Operação Tributável Monofásica - Revenda a Alíquota Zero
      else if ycst='05' then
        result:=stcofinsValorAliquotaPorST             // '05' // Operação Tributável por Substituição Tributária
      else if ycst='06' then
        result:=stcofinsAliquotaZero                   // '06' // Operação Tributável a Alíquota Zero
      else if ycst='07' then
        result:=stcofinsIsentaContribuicao            // '07' // Operação Isenta da Contribuição
      else if ycst='08' then
        result:=stcofinsSemIncidenciaContribuicao     // '08' // Operação sem Incidência da Contribuição
      else if ycst='09' then
        result:=stcofinsSuspensaoContribuicao        // '09' // Operação com Suspensão da Contribuição
      else if ycst='49' then
        result:=stcofinsOutrasOperacoesSaida        // '49' // Outras Operações de Saída
      else if ycst='50' then
        result:=stcofinsOperCredExcRecTribMercInt    // '50' // Operação com Direito a Crédito - Vinculada Exclusivamente a Receita Tributada no Mercado Interno
      else if ycst='51' then
        result:=stcofinsOperCredExcRecNaoTribMercInt  // '51' // Operação com Direito a Crédito - Vinculada Exclusivamente a Receita Não-Tributada no Mercado Interno
      else if ycst='52' then
        result:=stcofinsOperCredExcRecExportacao             // '52' // Operação com Direito a Crédito - Vinculada Exclusivamente a Receita de Exportação
      else if ycst='53' then
        result:=stcofinsOperCredRecTribNaoTribMercInt        // '53' // Operação com Direito a Crédito - Vinculada a Receitas Tributadas e Não-Tributadas no Mercado Interno
      else if ycst='54' then
        result:=stcofinsOperCredRecTribMercIntEExportacao    // '54' // Operação com Direito a Crédito - Vinculada a Receitas Tributadas no Mercado Interno e de Exportação
      else if ycst='55' then
        result:=stcofinsOperCredRecNaoTribMercIntEExportacao  // '55' // Operação com Direito a Crédito - Vinculada a Receitas Não Tributadas no Mercado Interno e de Exportação
      else if ycst='56' then
        result:=stcofinsOperCredRecTribENaoTribMercIntEExportacao  // '56' // Operação com Direito a Crédito - Vinculada a Receitas Tributadas e Não-Tributadas no Mercado Interno e de Exportação
      else if ycst='60' then
        result:=stcofinsCredPresAquiExcRecTribMercInt        // '60' // Crédito Presumido - Operação de Aquisição Vinculada Exclusivamente a Receita Tributada no Mercado Interno
      else if ycst='61' then
        result:=stcofinsCredPresAquiExcRecNaoTribMercInt     // '61' // Crédito Presumido - Operação de Aquisição Vinculada Exclusivamente a Receita Não-Tributada no Mercado Interno
      else if ycst='62' then
        result:=stcofinsCredPresAquiExcExcRecExportacao      // '62' // Crédito Presumido - Operação de Aquisição Vinculada Exclusivamente a Receita de Exportação
      else if ycst='63' then
        result:=stcofinsCredPresAquiRecTribNaoTribMercInt   // '63' // Crédito Presumido - Operação de Aquisição Vinculada a Receitas Tributadas e Não-Tributadas no Mercado Interno
      else if ycst='64' then
        result:=stcofinsCredPresAquiRecTribMercIntEExportacao     // '64' // Crédito Presumido - Operação de Aquisição Vinculada a Receitas Tributadas no Mercado Interno e de Exportação
      else if ycst='65' then
        result:=stcofinsCredPresAquiRecNaoTribMercIntEExportacao  // '65' // Crédito Presumido - Operação de Aquisição Vinculada a Receitas Não-Tributadas no Mercado Interno e de Exportação
      else if ycst='66' then
        result:=stcofinsCredPresAquiRecTribENaoTribMercIntEExportacao // '66' // Crédito Presumido - Operação de Aquisição Vinculada a Receitas Tributadas e Não-Tributadas no Mercado Interno e de Exportação
      else if ycst='67' then
        result:=stcofinsOutrasOperacoes_CredPresumido        // '67' // Crédito Presumido - Outras Operações
      else if ycst='70' then
        result:=stcofinsOperAquiSemDirCredito          // '70' // Operação de Aquisição sem Direito a Crédito
      else if ycst='71' then
        result:=stcofinsOperAquiComIsensao             // '71' // Operação de Aquisição com Isenção
      else if ycst='72' then
        result:=stcofinsOperAquiComSuspensao           // '72' // Operação de Aquisição com Suspensão
      else if ycst='73' then
        result:=stcofinsOperAquiAliquotaZero          // '73' // Operação de Aquisição a Alíquota Zero
      else if ycst='74' then
        result:=stcofinsOperAqui_SemIncidenciaContribuicao   // '74' // Operação de Aquisição sem Incidência da Contribuição
      else if ycst='75' then
        result:=stcofinsOperAquiPorST                 // '75' // Operação de Aquisição por Substituição Tributária
      else if ycst='98' then
        result:=stcofinsOutrasOperacoesEntrada        // '98' // Outras Operações de Entrada
      else // if ycst='99' then
        result:= stcofinsOutrasOperacoes;                                // '99' // Outras Operações
