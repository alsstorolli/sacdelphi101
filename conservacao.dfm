object FConservacao: TFConservacao
  Left = 306
  Top = 135
  BorderStyle = bsDialog
  Caption = 'Conserva'#231#227'o de Produtos'
  ClientHeight = 479
  ClientWidth = 750
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdCons_codigo: TSQLEd
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TConservacao
          TableName = 'conservacao'
          TableField = 'Cons_codigo'
          PanelMessages = PMens
        end
        object EdCons_linha1: TSQLEd
          Left = 95
          Top = 22
          Width = 500
          Height = 21
          ...
          Table = Arq.TConservacao
          TableName = 'conservacao'
          TableField = 'Cons_linha1'
          PanelMessages = PMens
        end
        object EdCons_linha2: TSQLEd
          Left = 95
          Top = 56
          Width = 400
          Height = 21
          ...
          Table = Arq.TConservacao
          TableName = 'conservacao'
          TableField = 'Cons_linha2'
          PanelMessages = PMens
        end
        object EdCons_linha3: TSQLEd
          Left = 95
          Top = 90
          Width = 400
          Height = 21
          ...
          Table = Arq.TConservacao
          TableName = 'conservacao'
          TableField = 'Cons_linha3'
          PanelMessages = PMens
        end
        object EdCons_linha4: TSQLEd
          Left = 95
          Top = 125
          Width = 400
          Height = 21
          ...
          Table = Arq.TConservacao
          TableName = 'conservacao'
          TableField = 'Cons_linha4'
          PanelMessages = PMens
        end
        object EdCons_linha5: TSQLEd
          Left = 95
          Top = 159
          Width = 400
          Height = 21
          ...
          Table = Arq.TConservacao
          TableName = 'conservacao'
          TableField = 'Cons_linha5'
          PanelMessages = PMens
        end
        object EdCons_linha6: TSQLEd
          Left = 95
          Top = 193
          Width = 400
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdCons_linha6ExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'cons_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cons_linha1'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cons_linha2'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cons_linha3'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cons_linha4'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cons_linha5'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cons_linha6'
            Visible = True
          end>
      end
    end
