object FCodigosFiscais: TFCodigosFiscais
  Left = 290
  Top = 160
  BorderStyle = bsDialog
  Caption = 'Cadastro de Codigos Fiscais de Impostos'
  ClientHeight = 356
  ClientWidth = 546
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdCfis_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo da simbologia tribut'#225'ria'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TCodigosFiscais
          TableName = 'codigosfis'
          TableField = 'Cfis_codigo'
          PanelMessages = PMens
        end
        object EdCfis_imposto: TSQLEd
          Left = 46
          Top = 14
          Width = 20
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Tipo do codigo do imposto '
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          ...
          Table = Arq.TCodigosFiscais
          TableName = 'codigosfis'
          TableField = 'Cfis_imposto'
          PanelMessages = PMens
        end
        object EdCfis_aliquota: TSQLEd
          Left = 70
          Top = 14
          Width = 48
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdCfis_aliquotaExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Percentual da al'#237'quota do imposto'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 3
          ValueFormat = '###,##0.000'
          ...
          Table = Arq.TCodigosFiscais
          TableName = 'codigosfis'
          TableField = 'Cfis_aliquota'
          PanelMessages = PMens
        end
        object Edcfis_percbase: TSQLEd
          Left = 388
          Top = 14
          Width = 49
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Percentual para calcular a base do icms de subst. tribut'#225'ria'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 3
          ValueFormat = '##0.000'
          ...
          Table = Arq.TCodigosFiscais
          TableName = 'codigosfis'
          TableField = 'Cfis_percbase'
          PanelMessages = PMens
        end
        object EdCfis_perctran: TSQLEd
          Left = 120
          Top = 14
          Width = 52
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Percentual para calcular o custo em transfer'#234'ncias'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 3
          ValueFormat = '###,##0.000'
          ...
          Table = Arq.TCodigosFiscais
          TableName = 'codigosfis'
          TableField = 'Cfis_perctran'
          PanelMessages = PMens
        end
        object Edcfis_redubase: TSQLEd
          Left = 175
          Top = 14
          Width = 59
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Percentual para calcular a redu'#231#227'o da base de c'#225'lculo'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 3
          ValueFormat = '###,##0.000'
          ...
          Table = Arq.TCodigosFiscais
          TableName = 'codigosfis'
          TableField = 'cfis_redubase'
          PanelMessages = PMens
        end
        object EdCfis_pis: TSQLEd
          Left = 238
          Top = 14
          Width = 50
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Percentual da al'#237'quota do Pis'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 2
          ValueFormat = '##0.00'
        ...
        object EdCfis_cofins: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Percentual da al'#237'quota do Cofins'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 2
          ValueFormat = '##0.00'
          ...
          Table = Arq.TCodigosFiscais
          TableName = 'codigosfis'
          TableField = 'Cfis_cofins'
          PanelMessages = PMens
        end
        object EdCfis_AliqST: TSQLEd
          Left = 344
          Top = 14
          Width = 40
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Percentual para calculo do icms de subst. tribut'#225'ria'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 3
          ValueFormat = '##0.000'
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'cfis_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cfis_imposto'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cfis_aliquota'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cfis_codfiscal'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cfis_percbase'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cfis_redubase'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cfis_perctran'
            Visible = True
          end
          item
            Expanded = False
          ...
          item
            Expanded = False
            FieldName = 'cfis_cofins'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'Cfis_AliqST'
            Visible = True
          end>
      end
    end
