object FMontaCargaCte: TFMontaCargaCte
  Left = 216
  Top = 111
  BorderStyle = bsDialog
  Caption = 'Montagem da Carga utilizando CT-e'
  ClientHeight = 524
  ClientWidth = 1086
  Color = clBtnFace
  ...
  object PCadastro: TPanel
    ...
    object PBotoes: TSQLPanelGrid
      ...
      object bmontacarga: TSQLBtn
        Left = 3
        Top = 92
        Width = 100
        Height = 30
        Hint = 'Grava a carga conforme as notas escolhidas'
        Caption = 'Monta Carga'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object bgeranfes: TSQLBtn
        ...
        Width = 100
        Height = 50
        Hint = 'Geras as notas fiscais'
        Caption = 'F5 Gera NFes'
        Enabled = False
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object bmarcatodos: TSQLBtn
        ...
        Width = 100
        Height = 30
        Hint = 'Marca os pedidos q far'#227'o parte da carga'
        Caption = 'Marca Todos'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object bdesmarcatodos: TSQLBtn
        ...
        Width = 100
        Height = 30
        Hint = 'Desmarca os pedidos q far'#227'o parte da carga'
      ...
      object brelcliente: TSQLBtn
        Left = 1
        Top = 4
        Width = 100
        Height = 33
        Hint = 'Relat'#243'rio de produtos por cliente'
        Caption = 'Rel. por &Cliente'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
      ...
      object brelporproduto: TSQLBtn
        Left = 2
        Top = 36
        Width = 100
        Height = 33
        Hint = 'Relat'#243'rio de produtos por carga'
        Caption = 'Rel. por &Produto'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
    ...
    object Panel1: TPanel
      ...
      object EdTran_codigo: TSQLEd
        ...
        ColorNotEnabled = clGray
        ColorTextNotEnabled = clWhite
        Title = 'C'#243'digo Ve'#237'culo/Transportador'
        TitlePos = tppTop
        TitleFont.Charset = DEFAULT_CHARSET
        TitleFont.Color = clWindowText
        TitleFont.Height = -11
      ...
      object pgrid: TSQLPanelGrid
        ...
        object Grid: TSqlDtGrid
          ...
          Columns = <
            ...
            item
              ...
              Title.Caption = 'Ordem'
              WidthColumn = 64
              MessageColumn = 'Ordem do pedido'
              FieldName = 'marcado'
            end>
          RowCountMin = 0
          SelectedIndex = 0
          Version = '2.0'
          PermitePesquisa = False
          ColWidths = (
            50
            55
            65
        ...
        object EdOrdem: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Ordem do pedido para carregamento'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ValueFormat = '00'
      ...
      object EdMoes_cola_codigo02: TSQLEd
        ...
        ShowForm = 'FColaboradores'
        OnExitEdit = EdMoes_cola_codigo02ExitEdit
        OnValidate = EdMoes_cola_codigo02Validate
        ColorFocus = clBlack
        ColorTextFocus = clWhite
        ColorNotEnabled = clGray
        ColorTextNotEnabled = clWhite
