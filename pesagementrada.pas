...
//                     ' and mova_tipomov='+stringtosql('EA')+
      ...
      if not Qb.Eof then begin
         ...
         EdBrinco.Invalid('Brinco já usado neste pedido')

      end else begin

// 17.11.20 - se é 'da fazenda'
  ...
  //                     ' inner join movabate on ( movd_numerodoc=mova_numerodoc and movd_transacao=mova_transacao )'+
          ...
          if not Qb.Eof then begin
             ...
             Avisoerro('ATENÇÃO - Brinco já usado EM OUTRO PEDIDO no. '+Qb.fieldbyname('movd_numerodoc').asstring);
...
// 16.11.20 - se é 'da fazenda'
      if codigocliente = 3465 then begin
        ...
        if Qb.eof then begin
         ...
         Avisoerro('Brinco não encontrado na FAZENDA');
