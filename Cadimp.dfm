object FCadimp: TFCadimp
  Left = 448
  Top = 204
  BorderStyle = bsDialog
  Caption = 'Cadastro De Impressos'
  ClientHeight = 418
  ClientWidth = 651
  Color = clBtnFace
  ...
  object PCadastro: TPanel
    ...
    object PBotoes: TSQLPanelGrid
      ...
      object bImpressora: TSQLBtn
        Left = 3
        Top = 253
        Width = 95
        Height = 25
        Hint = 'Indica'#231#227'o da impressora para o documento nesta esta'#231#227'o'
        Caption = 'I&mpressora'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object bAlteraContador: TSQLBtn
        Left = 3
        Top = 278
        Width = 95
        Height = 25
        Hint = 'Atualiza posi'#231#227'o do contador do impresso selecionado'
        Caption = 'Co&ntador'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdImpr_codigo: TSQLEd
          ...
          Text = ''
          Visible = True
          OnKeyPress = EdImpr_codigoKeyPress
          Empty = True
          CloseForm = False
          CloseFormEsc = False
          ColorFocus = clBlack
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo do impresso'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          ValueFormat = '000'
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TImpressos
          TableName = 'IMPRESSOS'
          TableField = 'Impr_codigo'
          PanelMessages = PMens
        end
        object EdImpr_descricao: TSQLEd
          Left = 44
          Top = 15
          Width = 298
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o do impresso'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TImpressos
          TableName = 'IMPRESSOS'
          TableField = 'Impr_descricao'
          PanelMessages = PMens
        end
        object EdImpr_formaimpressao: TSQLEd
          Left = 509
          Top = 15
          Width = 20
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdImpr_formaimpressaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Forma de impress'#227'o do documento'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Items.Strings = (
            '0 - N'#227'o imprime'
            '1 - Solicita impress'#227'o'
            '2 - Imprime autom'#225'ticamente'
            '3 - imprime por comando')
          ItemsMultiples = False
          ItemsValid = True
          ItemsWidth = 0
          ItemsHeight = 0
          ...
          Table = Arq.TImpressos
          TableName = 'IMPRESSOS'
          TableField = 'Impr_formaimpressao'
          PanelMessages = PMens
        end
        object EdImpr_tipo: TSQLEd
          Left = 349
          Top = 15
          Width = 31
          Height = 21
          ...
          Table = Arq.TImpressos
          TableName = 'IMPRESSOS'
          TableField = 'Impr_tipo'
          PanelMessages = PMens
        end
        object EdImpr_nomecontador: TSQLEd
          Left = 386
          Top = 15
          Width = 87
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Nome do contador dos documentos impressos'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TImpressos
          TableName = 'IMPRESSOS'
          TableField = 'Impr_nomecontador'
          PanelMessages = PMens
        end
        object EdImpr_geral: TSQLEd
          Left = 480
          Top = 15
          Width = 20
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Contador geral ou por unidade'
          ValueDefault = 'G'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          ...
          OpGrids = [ogFilter, ogFind]
          Items.Strings = (
            'G - Geral para todas as unidades'
            'U - Contador individualizado por unidade')
          ItemsMultiples = False
          ItemsValid = True
          ItemsWidth = 0
          ItemsHeight = 0
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'IMPR_CODIGO'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'IMPR_DESCRICAO'
            Visible = True
          end
          item
            Expanded = False
          ...
          item
            Expanded = False
            FieldName = 'IMPR_NOMECONTADOR'
            Visible = True
          end
          item
            Alignment = taCenter
            Expanded = False
            FieldName = 'IMPR_GERAL'
            Title.Caption = 'G/U'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'IMPR_FORMAIMPRESSAO'
            Visible = True
          end>
      end
    end
