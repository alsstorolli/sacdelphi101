object FMaterial: TFMaterial
  ...
  Caption = 'Cadastro de Material Predominante'
  ClientHeight = 458
  ClientWidth = 500
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdMate_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo do material'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ...
          Table = Arq.TMaterial
          TableName = 'material'
          TableField = 'Mate_codigo'
          PanelMessages = PMens
        end
        object EdMate_descricao: TSQLEd
          Left = 55
          Top = 16
          Width = 250
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdMate_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o do material'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'mate_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'mate_descricao'
            Visible = True
          end>
      end
    end
