object FBaias: TFBaias
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Cadastro de Baias'
  ClientHeight = 425
  ClientWidth = 591
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdBaia_codigo: TSQLEd
          ...
          Table = Arq.TBaias
          TableName = 'baias'
          TableField = 'Baia_codigo'
          PanelMessages = PMens
        end
        object EdBaia_descricao: TSQLEd
          Left = 46
          Top = 14
          Width = 157
          Height = 21
          ...
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Descri'#231#227'o da baia'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o da baia'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TBaias
          TableName = 'baias'
          TableField = 'Baia_descricao'
          PanelMessages = PMens
        end
        object EBaia_cabecas: TSQLEd
          Left = 209
          Top = 14
          Width = 44
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'N'#250'mero de cabe'#231'as na baia'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ValueFormat = '###,##0'
          ...
          Table = Arq.TBaias
          TableName = 'baias'
          TableField = 'Baia_cabecas'
          PanelMessages = PMens
        end
        object EdBaia_sexo: TSQLEd
          Left = 268
          Top = 14
          Width = 45
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Sexo dos animais na baia'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TBaias
          TableName = 'baias'
          TableField = 'Baia_sexo'
          PanelMessages = PMens
        end
        object Edbaia_ganhopeso: TSQLEd
          Left = 327
          Top = 14
          Width = 71
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = Edbaia_ganhopesoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'baia_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'baia_descricao'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'Baia_cabecas'
            Visible = True
          end
          item
            Expanded = False
