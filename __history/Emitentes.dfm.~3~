object FEmitentes: TFEmitentes
  Left = 211
  Top = 128
  BorderStyle = bsDialog
  Caption = 'Cadastro de Emitentes de Cheques Recebidos'
  ClientHeight = 453
  ClientWidth = 688
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdEmit_banco: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo do banco da conta'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          ValueFormat = '000'
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TEmitentes
          TableName = 'emitentes'
          TableField = 'Emit_banco'
          PanelMessages = PMens
        end
        object EdEmit_agencia: TSQLEd
          Left = 65
          Top = 18
          Width = 80
          Height = 21
          ...
          Table = Arq.TEmitentes
          TableName = 'emitentes'
          TableField = 'Emit_agencia'
          PanelMessages = PMens
        end
        object EdEmit_conta: TSQLEd
          Left = 169
          Top = 18
          Width = 100
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnValidate = EdEmit_contaValidate
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          Table = Arq.TEmitentes
          TableName = 'emitentes'
          TableField = 'Emit_conta'
          PanelMessages = PMens
        end
        object EdEmit_descricao: TSQLEd
          Left = 275
          Top = 18
          Width = 300
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdEmit_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o da conta corrente'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TEmitentes
          TableName = 'emitentes'
          TableField = 'Emit_descricao'
          PanelMessages = PMens
        end
        object EdEmit_cheq_cnpjcpf: TSQLEd
          Left = 7
          Top = 56
          Width = 110
          Height = 21
          ...
          CloseFormEsc = False
          OnExitEdit = EdEmit_descricaoExitEdit
          OnValidate = EdEmit_cheq_cnpjcpfValidate
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'emit_banco'
            Visible = True
          end
          item
            Alignment = taCenter
            Expanded = False
            FieldName = 'emit_agencia'
          ...
          item
            Expanded = False
            FieldName = 'emit_conta'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'emit_descricao'
            Width = 350
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'emit_cheq_cnpjcpf'
            Width = 70
            Visible = True
          end>
      end
