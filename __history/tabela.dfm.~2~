object FTabela: TFTabela
  ...
  Caption = 'Cadastro de Percentuais para Pre'#231'os'
  ClientHeight = 388
  ClientWidth = 415
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdTabp_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo do percentual'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TTabelaPreco
          TableName = 'tabelapreco'
          TableField = 'Tabp_codigo'
          PanelMessages = PMens
        end
        object EdTabp_aliquota: TSQLEd
          Left = 41
          Top = 13
          Width = 54
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Percentual para lista de pre'#231'o'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 3
          ValueFormat = '##0.000%'
          ...
          Table = Arq.TTabelaPreco
          TableName = 'tabelapreco'
          TableField = 'Tabp_aliquota'
          PanelMessages = PMens
        end
        object EdTabp_tipo: TSQLEd
          Left = 201
          Top = 13
          Width = 20
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdTabp_tipoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'D=Desconto   A=Acr'#233'scimo'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TTabelaPreco
          TableName = 'tabelapreco'
          TableField = 'Tabp_tipo'
          PanelMessages = PMens
        end
        object EdTabp_usua_codigo: TSQLEd
          Left = 229
          Top = 13
          Width = 37
          Height = 21
          ...
          Table = Arq.TTabelaPreco
          TableName = 'tabelapreco'
          TableField = 'Tabp_usua_codigo'
          PanelMessages = PMens
        end
        object Edtabp_unidadesmvto: TSQLEd
          Left = 101
          Top = 13
          Width = 97
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Unidades liberadas para uso desta tabela'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'tabp_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'tabp_aliquota'
            Visible = True
          end
          item
            Expanded = False
