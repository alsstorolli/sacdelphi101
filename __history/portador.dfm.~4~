    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdPort_codigo: TSQLEd
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TPortadores
          TableName = 'PORTADORES'
          TableField = 'Port_codigo'
          PanelMessages = PMens
        end
        object EdPort_descricao: TSQLEd
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdPort_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          Table = Arq.TPortadores
          TableName = 'PORTADORES'
          TableField = 'Port_descricao'
          PanelMessages = PMens
        end
        object EdPort_Plan_conta: TSQLEd
          Left = 272
          Top = 15
          Width = 54
          Height = 21
