    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdRegi_codigo: TSQLEd
          ...
          Text = ''
          Visible = True
          OnKeyPress = EdRegi_codigoKeyPress
          Empty = False
          CloseForm = False
          CloseFormEsc = False
          ColorFocus = clBlack
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo da regi'#227'o'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          ValueFormat = '000'
          ...
          Table = Arq.TRegioes
          TableName = 'REGIOES'
          TableField = 'Regi_codigo'
          PanelMessages = PMens
        end
        object EdRegi_descricao: TSQLEd
          Left = 49
          Top = 15
          Width = 250
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdRegi_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Descri'#231#227'o Regi'#227'o'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o da regi'#227'o'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'REGI_CODIGO'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'REGI_DESCRICAO'
            Visible = True
          end>
      end
    end
