object FGrades: TFGrades
  Left = 89
  Top = 184
  BorderStyle = bsDialog
  Caption = 'Cadastro de Grades do Estoque'
  ClientHeight = 408
  ClientWidth = 831
  Color = clBtnFace
  ...
  object PCadastro: TPanel
    ...
    object PBotoes: TSQLPanelGrid
      ...
      object bConfigurar: TSQLBtn
        Left = 3
        Top = 229
        Width = 95
        Height = 25
        Hint = 'Configura a grade'
        Caption = '&Confi&gurar'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdGrad_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo da grade'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ...
          Table = Arq.TGrades
          TableName = 'GRADES'
          TableField = 'Grad_codigo'
          PanelMessages = PMens
        end
        object EdGrad_descricao: TSQLEd
          Left = 55
          Top = 16
          Width = 136
          Height = 21
          ...
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Descri'#231#227'o da grade'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          ...
          Table = Arq.TGrades
          TableName = 'GRADES'
          TableField = 'Grad_descricao'
          PanelMessages = PMens
        end
        object EdGrad_codigolinha: TSQLEd
          Left = 201
          Top = 18
          Width = 40
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnValidate = EdGrad_codigolinhaValidate
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Codigo da linha'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          ...
          Table = Arq.TGrades
          TableName = 'GRADES'
          TableField = 'Grad_codigolinha'
          PanelMessages = PMens
        end
        object EdGrad_codigocoluna: TSQLEd
          Left = 279
          Top = 18
          Width = 40
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdGrad_codigocolunaExitEdit
          OnValidate = EdGrad_codigocolunaValidate
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Codigo da coluna'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          ...
          Table = Arq.TGrades
          TableName = 'GRADES'
          TableField = 'Grad_codigocoluna'
          PanelMessages = PMens
        end
        object EdGrad_linha: TSQLEd
          Left = 413
          Top = 14
          Width = 62
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digos da linha'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TGrades
          TableName = 'GRADES'
          TableField = 'Grad_linha'
          PanelMessages = PMens
        end
        object EdGrad_coluna: TSQLEd
          Left = 486
          Top = 16
          Width = 69
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digos da coluna'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TGrades
          TableName = 'GRADES'
          TableField = 'Grad_coluna'
          PanelMessages = PMens
        end
        object EdGrad_usua_codigo: TSQLEd
          Left = 360
          Top = 14
          Width = 50
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Usu'#225'rio respons'#225'vel pelo cadastramento'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'grad_descricao'
            Title.Caption = 'Descri'#231#227'o'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'grad_codigolinha'
            Title.Caption = 'Codigo linha'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'grad_codigocoluna'
            Title.Caption = 'Codigo coluna'
            Visible = True
          end>
      end
      object PGrade: TSQLPanelGrid
        ...
        object Gridlinha: TSqlDtGrid
          ...
          TabOrder = 4
          OnDblClick = GridlinhaDblClick
          OnKeyPress = GridlinhaKeyPress
          Columns = <
            item
              WidthColumn = 64
            end
        ...
        object Gridcoluna: TSqlDtGrid
          ...
          Options = [goFixedVertLine, goFixedHorzLine, goVertLine, goHorzLine, goColSizing]
          TabOrder = 5
          OnClick = GridcolunaClick
          OnKeyPress = GridcolunaKeyPress
          Columns = <
            item
              WidthColumn = 64
            end
        ...
        object EdGrade: TSQLEd
          ...
          CloseForm = False
          CloseFormEsc = False
          OnValidate = EdGradeValidate
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clBlue
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
