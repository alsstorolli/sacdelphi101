object FTiposNotas: TFTiposNotas
  Left = 345
  Top = 192
  BorderStyle = bsDialog
  Caption = 'Cadastro de Tipos de Notas'
  ClientHeight = 446
  ClientWidth = 754
  Color = clBtnFace
  ...
  object PCadastro: TPanel
    ...
    object PBotoes: TSQLPanelGrid
      ...
      object bgrava: TSQLBtn
        Left = 3
        Top = 228
        Width = 95
        Height = 25
        Hint = 'Grava as informa'#231#245'es'
        Caption = '&Grava'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdTipn_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Codigo do tipo de nota'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TTiposNota
          TableName = 'tiposnota'
          TableField = 'Tipn_codigo'
          PanelMessages = PMens
        end
        object EdTipn_descricao: TSQLEd
          Left = 65
          Top = 19
          Width = 250
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdTipn_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o do tipo de nota'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'tipn_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'tipn_descricao'
            Visible = True
          end>
      end
      object pincidencias: TSQLPanelGrid
        Left = 412
        Top = 1
        Width = 239
        Height = 370
