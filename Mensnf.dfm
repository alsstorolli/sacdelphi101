object FMensNotas: TFMensNotas
  ...
  object PBotoes: TSQLPanelGrid
    ...
    object bFsc: TSQLBtn
      ...
      Width = 95
      Height = 25
      Hint = 'Informa'#231#245'es do FSC'
      Caption = 'FSC'
      Flat = True
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
  ...
  object Panel1: TPanel
    ...
    object PEdits: TSQLPanelGrid
      ...
      object Edmens_codigo: TSQLEd
        ...
        MinLength = 0
        Group = 0
        Table = Arq.TMensagensNF
        TableName = 'mensagensnf'
        TableField = 'mens_codigo'
        PanelMessages = PMens
      end
      object Edmens_descricao: TSQLEd
        Left = 43
        Top = 14
        Width = 344
        Height = 21
        ...
        CloseForm = False
        CloseFormEsc = False
        OnExitEdit = Edmens_descricaoExitEdit
        ColorFocus = clBlack
        ColorTextFocus = clWhite
        ColorNotEnabled = clGray
        ColorTextNotEnabled = clWhite
        ...
        TitleFont.Style = []
        TitlePixels = 0
        MessageStr = 'Descri'#231#227'o da mensagem'
        TypeValue = tvString
        ValueNegative = False
        Decimals = 0
        CharUpperLower = False
    ...
    object Grid: TSQLGrid
      ...
      Columns = <
        item
          Expanded = False
          FieldName = 'MENS_CODIGO'
          Width = 82
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'MENS_DESCRICAO'
          Width = 285
          Visible = True
        end>
    end
    object PFsc: TSQLPanelGrid
      Left = 249
      Top = 200
      Width = 185
      Height = 101
  ...
  object DSMensagensNF: TDataSource
    DataSet = Arq.TMensagensNF
    Left = 328
    Top = 80
  end
end
