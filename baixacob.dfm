object FBaixaCobranca: TFBaixaCobranca
  Left = 310
  Top = 203
  BorderStyle = bsDialog
  Caption = 'Baixa de Cobran'#231'a Banc'#225'ria'
  ClientHeight = 453
  ClientWidth = 1072
  Color = clBtnFace
  ...
  object SQLPanelGrid1: TSQLPanelGrid
    ...
    object SQLPanelGrid2: TSQLPanelGrid
      ...
      object bpendentes: TSQLBtn
        Left = 1
        Top = 29
        Width = 95
        Height = 25
        Hint = 'Relat'#243'rio titulos pendentes'
        Caption = '&Pendentes'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object bexclui: TSQLBtn
        Left = 1
        Top = 55
        Width = 95
        Height = 25
        Hint = 'Exclui boleto que veio no arquivo de retorno'
        Caption = '&Excluir'
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object SQLPanelGrid4: TSQLPanelGrid
        ...
        object PInicial: TSQLPanelGrid
          ...
          object EdSeunumero: TSQLEd
            ...
            Text = ''
            Visible = False
            OnExit = EdSeunumeroExitEdit
            Empty = True
            CloseForm = False
            CloseFormEsc = False
            OnExitEdit = EdSeunumeroExitEdit
            OnValidate = EdSeunumeroValidate
            ColorFocus = clBlack
            ...
            TitleFont.Style = []
            TitlePixels = 0
            MessageStr = 'F12 consulta t'#237'tulos'
            TypeValue = tvString
            ValueNegative = False
            Decimals = 0
        ...
        object PAcerto: TSQLPanelGrid
          ...
          object EdDataBaixa: TSQLEd
            ...
            CloseForm = False
            CloseFormEsc = False
            OnValidate = EdDataBaixaValidate
            ColorFocus = clBlack
            ColorTextFocus = clWhite
            ColorNotEnabled = clGray
            ColorTextNotEnabled = clWhite
          ...
          object EdBoletosEntrada: TSQLEd
            Left = 680
            Top = 20
            Width = 55
            Height = 21
          ...
          object EdBoletosEnviados: TSQLEd
            Left = 760
            Top = 19
            Width = 55
            Height = 21
  ...
  object OpenDialog1: TOpenDialog
    DefaultExt = 'TXT'
    Filter = 'Retornos|*.RET;*.CRT|Retorno Sicredi|*.CRT|Texto|*.TXT|Todos|*.*'
    Left = 368
    Top = 3
  end
