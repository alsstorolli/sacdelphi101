    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdCadm_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Codigo do m'#227'o de obra'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ...
          Table = Arq.TServicos
          TableName = 'cadmobra'
          TableField = 'Cadm_codigo'
          PanelMessages = PMens
        end
        object EdCadm_descricao: TSQLEd
          Left = 60
          Top = 18
          Width = 231
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o da M'#227'o de Obra'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TServicos
          TableName = 'cadmobra'
          TableField = 'Cadm_descricao'
          PanelMessages = PMens
        end
        object EdCadm_unitario: TSQLEd
          Left = 296
          Top = 18
          Width = 54
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Valor unit'#225'rio da M'#227'o de Obra'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 4
          ValueFormat = '###,##0.0000'
          ...
          Table = Arq.TServicos
          TableName = 'cadmobra'
          TableField = 'Cadm_unitario'
          PanelMessages = PMens
        end
        object EdCadm_unidade: TSQLEd
          Left = 356
          Top = 18
          Width = 44
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdCadm_unidadeExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Unidade da M'#227'o de Obra'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          ...
          Table = Arq.TServicos
          TableName = 'cadmobra'
          TableField = 'Cadm_unidade'
          PanelMessages = PMens
        end
        object EdCadm_somatotal: TSQLEd
          Left = 593
          Top = 6
          Width = 34
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Se soma no total da nota '
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          Items.Strings = (
            'N - N'#227'o soma no total da nota'
            'S - soma no total da nota')
          ItemsMultiples = False
          ItemsValid = True
          ItemsWidth = 0
          ItemsHeight = 0
          ...
          Table = Arq.TServicos
          TableName = 'cadmobra'
          TableField = 'Cadm_somatotal'
          PanelMessages = PMens
        end
        object EdCadm_incideinss: TSQLEd
          Left = 631
          Top = 6
          Width = 32
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Se forma base de c'#225'lculo no Inss retido da nota'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          Items.Strings = (
            'N - N'#227'o incide INSS'
            'S - Incide INSS')
          ItemsMultiples = False
          ItemsValid = True
          ItemsWidth = 0
          ...
          Table = Arq.TServicos
          TableName = 'cadmobra'
          TableField = 'Cadm_incideinss'
          PanelMessages = PMens
        end
        object EdCadm_pulalinha: TSQLEd
          Left = 563
          Top = 6
          Width = 40
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Numero de linha para pula na impress'#227'o da nota de servi'#231'os'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ValueFormat = '#0'
          ...
          Table = Arq.TServicos
          TableName = 'cadmobra'
          TableField = 'Cadm_pulalinha'
          PanelMessages = PMens
        end
        object Edcadm_nivel: TSQLEd
          Left = 406
          Top = 18
          Width = 39
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'N'#237'vel do l'#237'quido no processo'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          ...
          Table = Arq.TServicos
          TableName = 'cadmobra'
          TableField = 'Cadm_nivel'
          PanelMessages = PMens
        end
        object Edcadm_temperatura: TSQLEd
          Left = 451
          Top = 19
          Width = 60
          Height = 21
          ...
          Table = Arq.TServicos
          TableName = 'cadmobra'
          TableField = 'Cadm_temperatura'
          PanelMessages = PMens
        end
        object Edcadm_tempo: TSQLEd
          Left = 517
          Top = 19
          Width = 44
          Height = 21
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'cadm_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cadm_descricao'
            Width = 200
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cadm_unitario'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cadm_unidade'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cadm_nivel'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cadm_temperatura'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cadm_tempo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cadm_somatotal'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cadm_incideinss'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'cadm_pulalinha'
            Visible = True
          end>
      end
    end
