    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdCore_codigo: TSQLEd
          ...
          Table = Arq.TCores
          TableName = 'cores'
          TableField = 'Core_codigo'
          PanelMessages = PMens
        end
        object EdCore_descricao: TSQLEd
          Left = 79
          Top = 16
          Width = 250
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdCore_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Descri'#231#227'o da cor'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
