object FMotivosBloq: TFMotivosBloq
  Left = 230
  Top = 149
  BorderStyle = bsDialog
  Caption = 'Cadastro de Motivos de Bloqueio'
  ClientHeight = 450
  ClientWidth = 484
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdBloq_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo do bloqueio'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ValueFormat = '##0'
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TBloqueios
          TableName = 'motbloqueios'
          TableField = 'Mobl_codigo'
          PanelMessages = PMens
        end
        object EdBloq_nome: TSQLEd
          Left = 49
          Top = 16
          Width = 250
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdBloq_nomeExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o do bloqueio'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
