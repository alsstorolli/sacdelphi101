    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdMoed_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo da moeda'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          ValueFormat = '000'
          ...
          Table = Arq.TMoedas
          TableName = 'MOEDAS'
          TableField = 'Moed_codigo'
          PanelMessages = PMens
        end
        object EdMoed_descricao: TSQLEd
          Left = 42
          Top = 15
          Width = 228
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o da moeda'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TMoedas
          TableName = 'MOEDAS'
          TableField = 'Moed_descricao'
          PanelMessages = PMens
        end
        object EdMoed_simbolo: TSQLEd
          Left = 278
          Top = 15
          Width = 49
          Height = 21
          ...
          Table = Arq.TMoedas
          TableName = 'MOEDAS'
          TableField = 'Moed_simbolo'
          PanelMessages = PMens
        end
        object EdMoed_singular: TSQLEd
          Left = 334
          Top = 15
          Width = 115
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o da moeda no singular'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TMoedas
          TableName = 'MOEDAS'
          TableField = 'Moed_singular'
          PanelMessages = PMens
        end
        object EdMoed_plural: TSQLEd
          Left = 456
          Top = 15
          Width = 115
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o da moeda no plural'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
          ...
          Table = Arq.TMoedas
          TableName = 'MOEDAS'
          TableField = 'Moed_plural'
          PanelMessages = PMens
        end
        object EdMoed_cotacao: TSQLEd
          Left = 578
          Top = 14
          Width = 80
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdMoed_cotacaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          Title = 'Cota'#231#227'o'
          TitlePos = tppTop
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Valor da cota'#231#227'o atual da moeda'
          TypeValue = tvFloat
          ValueNegative = False
          Decimals = 5
          ValueFormat = '###,##0.00000'
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'MOED_CODIGO'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'MOED_DESCRICAO'
            Width = 235
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'MOED_SIMBOLO'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'MOED_SINGULAR'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'MOED_PLURAL'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'MOED_COTACAO'
