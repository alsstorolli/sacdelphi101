object FCadOcorrencias: TFCadOcorrencias
  Left = 362
  Top = 191
  BorderStyle = bsDialog
  Caption = 'Cadastro de Tipos de Ocorr'#234'ncias'
  ClientHeight = 325
  ClientWidth = 464
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdCaoc_descricao: TSQLEd
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdCaoc_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
