object FPlano: TFPlano
  ...
  object PCadastro: TPanel
    ...
    object PBotoes: TSQLPanelGrid
      ...
      object bConfig: TSQLBtn
        Left = 3
        Top = 228
        Width = 95
        Height = 25
        Hint = 'Acesso '#224' configura'#231#227'o da conta selecionada'
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        WidthLimite = 0
        FixedVisible = False
        object EdPlan_classificacao: TSQLEd
          Left = 2
          Top = 15
          Width = 147
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo de classifica'#231#227'o da conta'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
        ...
        object EdPlan_conta: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo reduzido da conta'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          CharUpperLower = False
          ...
          Table = Arq.TPlano
          TableName = 'PLANO'
          TableField = 'Plan_conta'
          PanelMessages = PMens
        end
        object EdPlan_tipo: TSQLEd
          Left = 558
          Top = 15
          Width = 30
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdPlan_tipoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          Items.Strings = (
            ...
            'M - Contas Movimento'
            'C - Contas Caixa'
            'B - Contas Banc'#225'rias'
            'E - Contas de Empr'#233'stimo'
            'P - CPR-Cedula Produtor Rural'
            'D - Desativada')
          ItemsMultiples = False
          ItemsValid = True
          ItemsWidth = 0
          ...
          Table = Arq.TPlano
          TableName = 'PLANO'
          TableField = 'Plan_tipo'
          PanelMessages = PMens
        end
        object EdPlan_cstpiscofins: TSQLEd
          Left = 466
          Top = 15
          Width = 30
          Height = 21
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'CST para pis/cofins'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          ValueFormat = '00'
