object FTabelaComissao: TFTabelaComissao
  Left = 524
  Top = 199
  Caption = 'Tabela de Comiss'#227'o'
  ClientHeight = 399
  ClientWidth = 490
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdTabc_seq: TSQLEd
          ...
          MinLength = 0
          Group = 0
          Table = Arq.TabelaComissao
          TableName = 'tabcomissao'
          TableField = 'Tabc_seq'
          PanelMessages = PMens
        end
        object EdTabc_inicio: TSQLEd
          Left = 75
          Top = 30
          Width = 50
          Height = 21
          ...
          Table = Arq.TabelaComissao
          TableName = 'tabcomissao'
          TableField = 'Tabc_inicio'
          PanelMessages = PMens
        end
        object EdTabc_fim: TSQLEd
          Left = 135
          Top = 30
          Width = 50
          Height = 21
        ...
        object EdTabc_faixa: TSQLEd
          ...
          Table = Arq.TabelaComissao
          TableName = 'tabcomissao'
          TableField = 'Tabc_faixa'
          PanelMessages = PMens
        end
        object EdTabc_usua_codigo: TSQLEd
          Left = 343
          Top = 6
          Width = 50
          Height = 21
          ...
          Table = Arq.TabelaComissao
          TableName = 'tabcomissao'
          TableField = 'Tabc_usua_codigo'
          PanelMessages = PMens
        end
        object EdTabc_dtlancto: TSQLEd
          Left = 299
          Top = 54
          Width = 49
          Height = 21
          ...
          Table = Arq.TabelaComissao
          TableName = 'tabcomissao'
          TableField = 'Tabc_dtlancto'
          PanelMessages = PMens
        end
        object EdTabc_repr_tiporepr: TSQLEd
          Left = 315
          Top = 30
          Width = 35
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdTabc_repr_tiporeprExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          Table = Arq.TabelaComissao
          TableName = 'tabcomissao'
          TableField = 'Tabc_repr_tiporepr'
          PanelMessages = PMens
        end
        object EdTabc_status: TSQLEd
          Left = 219
          Top = 57
          Width = 50
          Height = 21
          ...
          Table = Arq.TabelaComissao
          TableName = 'tabcomissao'
          TableField = 'Tabc_status'
          PanelMessages = PMens
        end
        object EdTabc_reflexo: TSQLEd
          Left = 251
          Top = 30
          Width = 60
          Height = 21
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'tabc_faixa'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'tabc_reflexo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'tabc_repr_tiporepr'
            Visible = True
          end>
      end
    end
