object FFamilias: TFFamilias
  Left = 291
  Top = 153
  BorderStyle = bsDialog
  Caption = 'Cadastro de Familias do Estoque'
  ClientHeight = 455
  ClientWidth = 461
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object PEdits: TSQLPanelGrid
        ...
        object EdFami_codigo: TSQLEd
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'C'#243'digo da familia'
          TypeValue = tvInteger
          ValueNegative = False
          Decimals = 0
          ...
          Table = Arq.TFamilias
          TableName = 'familias'
          TableField = 'Fami_codigo'
          PanelMessages = PMens
        end
        object EdFami_descricao: TSQLEd
          Left = 55
          Top = 16
          Width = 250
          Height = 21
          ...
          CloseForm = False
          CloseFormEsc = False
          OnExitEdit = EdFami_descricaoExitEdit
          ColorFocus = clBlack
          ColorTextFocus = clWhite
          ColorNotEnabled = clGray
          ColorTextNotEnabled = clWhite
          ...
          TitleFont.Style = []
          TitlePixels = 0
          MessageStr = 'Descri'#231#227'o da familia'
          TypeValue = tvString
          ValueNegative = False
          Decimals = 0
          CharUpperLower = True
      ...
      object Grid: TSQLGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'fami_codigo'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'fami_descricao'
            Visible = True
          end>
      end
    end
